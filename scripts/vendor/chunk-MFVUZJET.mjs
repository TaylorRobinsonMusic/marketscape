...
var T = Q("LayoutMeasureQueue"),
  ...
  Ge = class {
    ...
    remeasureChildrenWithDOMRects(e) {
      if ((T.trace("remeasureChildrenWithLayout:", e.id), !!e.children && !ae(e)))
    ...
    remeasureLayoutChildren(e) {
      if ((T.trace("remeasureLayoutChildren:", e.id), !!ae(e)))
        for (let t of e.children)
          this.remeasureCachedElements(t, (n, r) => {
...
//# sourceMappingURL=chunk-MFVUZJET.mjs.map
