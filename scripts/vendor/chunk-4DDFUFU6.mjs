  ...
  (function (s, i) {
    ...
    return (function (s) {
      ...
      return (
        ...
        (l.c = i),
        (l.d = function (o, d, u) {
          l.o(o, d) || Object.defineProperty(o, d, { enumerable: !0, get: u });
        }),
        (l.r = function (o) {
          (typeof Symbol < "u" &&
            Symbol.toStringTag &&
      ...
      function (s, i, l) {
        ...
        var o =
            ...
            (Object.create
              ? function (u, p, n, e) {
                  e === void 0 && (e = n);
                  var a = Object.getOwnPropertyDescriptor(p, n);
              ...
              : function (u, p, n, e) {
                  (e === void 0 && (e = n), (u[e] = p[n]));
                }),
          d =
            (this && this.__exportStar) ||
            function (u, p) {
              for (var n in u)
                n === "default" || Object.prototype.hasOwnProperty.call(p, n) || o(p, u, n);
            };
...
%c${JSON.stringify(a, null, 2)}`),
          ...
          post(e) {
            ...
            let m = {
              data: Object.assign(Object.assign({}, e), { context: a, uuid: e.uuid || p() }),
...
`),
          ...
          scheduleFlush() {
            ...
            (this.flushDeadlineTimer ||
              (this.flushDeadlineTimer = setTimeout(t, this.withBackoff(p))),
              clearTimeout(this.flushTimer),
...
`);
      ...
      function (s, i, l) {
        ...
        var o =
          (this && this.__awaiter) ||
          function (d, u, p, n) {
            return new (p || (p = Promise))(function (e, a) {
              function m(r) {
                try {
                  t(n.next(r));
                } catch (c) {
              ...
              t((n = n.apply(d, u || [])).next());
            });
          };
        (Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.postBatch = void 0),
          (i.postBatch = function (d, u) {
            return o(this, void 0, void 0, function* () {
              let p = yield fetch(d, {
                method: "POST",
                mode: "cors",
              ...
              if (!p.ok) throw Error(`Server responded with ${p.statusText}`);
              p.type !== "opaque" && (yield p.json());
            });
          }));
      },
      function (s, i, l) {
  ...
  O = new P.FramerTracking({
    ...
    addContext: (s) => {
      ...
      (i?.stores?.scopeStore &&
        ...
        s.appVersion === void 0 && (s.appVersion = "FramerWeb/3f060d6"),
...
//# sourceMappingURL=chunk-4DDFUFU6.mjs.map
