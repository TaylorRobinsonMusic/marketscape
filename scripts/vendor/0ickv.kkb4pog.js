  ...
  (e) => {
    ...
    class s {
      ...
      forward(e, t, s, i) {
        return i && !this.debug
          ? null
          : ("string" == typeof e[0] && (e[0] = `${s}${this.prefix} ${e[0]}`), this.logger[t](e));
      }
      create(e) {
        return new s(this.logger, { ...{ prefix: `${this.prefix}:${e}:` }, ...this.options });
      }
      clone(e) {
    ...
    function a(e, t, s) {
      ...
      let r = "string" != typeof t ? [].concat(t) : t.split(".");
      for (; r.length > 1; ) {
        if (n()) return {};
        let t = i(r.shift());
        (!e[t] && s && (e[t] = new s()),
      ...
      return n() ? {} : { obj: e, k: i(r.shift()) };
    }
    function l(e, t, s) {
      let { obj: i, k: n } = a(e, t, Object);
      i[n] = s;
    }
    function u(e, t) {
      let { obj: s, k: i } = a(e, t);
    ...
    function d(e, t) {
      ...
      for (let e = 0; e < i.length; ++e) {
        if (!n || ("string" == typeof n[i[e]] && e + 1 < i.length)) return;
        if (void 0 === n[i[e]]) {
          let r = 2,
            o = i.slice(e, e + r).join(s),
            a = n[o];
          for (; void 0 === a && i.length > e + r; )
            (r++, (a = n[(o = i.slice(e, e + r).join(s))]));
          if (void 0 === a) return;
          if (null === a) return null;
          if (t.endsWith(o)) {
            if ("string" == typeof a) return a;
            if (o && "string" == typeof a[o]) return a[o];
          }
          let l = i.slice(e + r).join(s);
          if (l) return d(a, l, s);
          return;
        }
        n = n[i[e]];
    ...
    class m extends n {
      ...
      getResource(e, t, s) {
        let i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          n = void 0 !== i.keySeparator ? i.keySeparator : this.options.keySeparator,
          r =
            void 0 !== i.ignoreJSONStructure
              ? i.ignoreJSONStructure
              : this.options.ignoreJSONStructure,
          o = [e, t];
        (s && "string" != typeof s && (o = o.concat(s)),
          s && "string" == typeof s && (o = o.concat(n ? s.split(n) : s)),
          e.indexOf(".") > -1 && (o = e.split(".")));
        let a = u(this.data, o);
        return a || !r || "string" != typeof s
          ? a
          : d(this.data && this.data[e] && this.data[e][t], s, n);
      }
      addResource(e, t, s, i) {
      ...
      addResources(e, t, s) {
        ...
        for (let i in s)
          ("string" == typeof s[i] || "[object Array]" === Object.prototype.toString.apply(s[i])) &&
            this.addResource(e, t, i, s[i], { silent: !0 });
        i.silent || this.emit("added", e, t, s);
      }
      addResourceBundle(e, t, s, i, n) {
        let r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : { silent: !1 },
          o = [e, t];
    ...
    class b extends n {
      ...
      extractFromKey(e, t) {
        ...
        let i = void 0 !== t.keySeparator ? t.keySeparator : this.options.keySeparator,
          ...
          o =
            ...
            !(function (e, t, s) {
              ((t = t || ""), (s = s || ""));
              let i = c.filter((e) => 0 > t.indexOf(e) && 0 > s.indexOf(e));
              if (0 === i.length) return !0;
              let n = RegExp(`(${i.map((e) => ("?" === e ? "\\?" : e)).join("|")})`),
                r = !n.test(e);
              if (!r) {
                let t = e.indexOf(s);
        ...
        if (r && !o) {
          ...
          let r = e.split(s);
          ((s !== i || (s === i && this.options.ns.indexOf(r[0]) > -1)) && (n = r.shift()),
            (e = r.join(i)));
        }
      ...
      translate(e, t, s) {
        ...
        let i = void 0 !== t.returnDetails ? t.returnDetails : this.options.returnDetails,
          ...
          { key: r, namespaces: o } = this.extractFromKey(e[e.length - 1], t),
          a = o[o.length - 1],
        ...
        if (l && "cimode" === l.toLowerCase()) {
          if (u) {
            ...
            return i
              ? { res: `${a}${e}${r}`, usedKey: r, exactUsedKey: r, usedLng: l, usedNS: a }
              : `${a}${e}${r}`;
          }
          return i ? { res: r, usedKey: r, exactUsedKey: r, usedLng: l, usedNS: a } : r;
        }
        let h = this.resolve(e, t),
          p = h && h.res,
          g = (h && h.usedKey) || r,
          c = (h && h.exactUsedKey) || r,
        ...
        if (
          ...
          p &&
          y &&
          0 > ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) &&
          ...
          if (n) {
            ...
            for (let e in p)
              if (Object.prototype.hasOwnProperty.call(p, e)) {
                let r = `${i}${n}${e}`;
                ((s[e] = this.translate(r, { ...t, joinArrays: !1, ns: o })),
                  s[e] === r && (s[e] = p[e]));
              }
            p = s;
          }
        } else if (m && "string" == typeof f && "[object Array]" === d)
          (p = p.join(f)) && (p = this.extendTranslation(p, e, t, s));
        else {
          let i = !1,
            o = !1,
            u = void 0 !== t.count && "string" != typeof t.count,
            g = b.hasDefaultValue(t),
            c = u ? this.pluralResolver.getSuffix(l, t.count, t) : "",
            d = t.ordinal && u ? this.pluralResolver.getSuffix(l, t.count, { ordinal: !1 }) : "",
            f = t[`defaultValue${c}`] || t[`defaultValue${d}`] || t.defaultValue;
          (!this.isValidLookup(p) && g && ((i = !0), (p = f)),
            this.isValidLookup(p) || ((o = !0), (p = r)));
          let m =
              (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && o
                ? void 0
                : p,
            y = g && f !== p && this.options.updateMissing;
          if (o || i || y) {
            if ((this.logger.log(y ? "updateKey" : "missingKey", l, a, r, y ? f : p), n)) {
              let e = this.resolve(r, { ...t, keySeparator: !1 });
              e &&
                e.res &&
                this.logger.warn(
            ...
            if ("fallback" === this.options.saveMissingTo && s && s[0])
              ...
              "all" === this.options.saveMissingTo
                ? (e = this.languageUtils.toResolveHierarchy(t.lng || this.language))
                : e.push(t.lng || this.language);
            let i = (e, s, i) => {
              let n = g && i !== p ? i : m;
              (this.options.missingKeyHandler
                ? this.options.missingKeyHandler(e, a, s, n, y, t)
                : this.backendConnector &&
                  this.backendConnector.saveMissing &&
                  this.backendConnector.saveMissing(e, a, s, n, y, t),
                this.emit("missingKey", e, a, s, p));
            };
            this.options.saveMissing &&
              (this.options.saveMissingPlurals && u
                ? e.forEach((e) => {
                    this.pluralResolver.getSuffixes(e, t).forEach((s) => {
                      i([e], r + s, t[`defaultValue${s}`] || f);
                    });
                  })
                : i(e, r, f));
          }
          ((p = this.extendTranslation(p, e, t, h, s)),
            o && p === r && this.options.appendNamespaceToMissingKey && (p = `${a}:${r}`),
            (o || i) &&
              this.options.parseMissingKeyHandler &&
              (p =
                "v1" !== this.options.compatibilityAPI
                  ? this.options.parseMissingKeyHandler(
                      this.options.appendNamespaceToMissingKey ? `${a}:${r}` : r,
                      i ? p : void 0
                    )
                  : this.options.parseMissingKeyHandler(p)));
        }
        return i ? ((h.res = p), h) : p;
      }
      extendTranslation(e, t, s, i, n) {
        ...
        if (this.i18nFormat && this.i18nFormat.parse)
          ...
          (!s.lng && "v1" !== this.options.compatibilityAPI && i && i.res && (s.lng = i.usedLng),
            !1 !== s.nest &&
        ...
        return (
          null != e &&
            ...
            (e = y.handle(
              ...
              e,
              t,
              this.options && this.options.postProcessPassResolved ? { i18nResolved: i, ...s } : s,
              this
            )),
          e
        );
      ...
      resolve(e) {
        ...
        return (
          ...
          e.forEach((e) => {
            ...
            let h = void 0 !== o.count && "string" != typeof o.count,
              p = h && !o.ordinal && 0 === o.count && this.pluralResolver.shouldUseIntlApi(),
              g =
                void 0 !== o.context &&
                ("string" == typeof o.context || "number" == typeof o.context) &&
                "" !== o.context,
              c = o.lngs
                ? o.lngs
                : this.languageUtils.toResolveHierarchy(o.lng || this.language, o.fallbackLng);
            u.forEach((e) => {
              this.isValidLookup(t) ||
                ...
                !v[`${c[0]}-${e}`] &&
                  ...
                  ((v[`${c[0]}-${e}`] = !0),
                  this.logger.warn(
                    `key "${s}" for languages "${c.join(", ")}" won't get resolved as namespace "${r}" was not yet loaded`,
                ...
                c.forEach((s) => {
                  ...
                  if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                    this.i18nFormat.addLookupKeys(a, l, s, e, o);
                  else {
                    let e;
                    h && (e = this.pluralResolver.getSuffix(s, o.count, o));
                    ...
                    if (
                      (h &&
                        ...
                        o.ordinal &&
                          0 === e.indexOf(i) &&
                          a.push(l + e.replace(i, this.options.pluralSeparator)),
                        p && a.push(l + t)),
                      g)
                    ) {
                      ...
                      (a.push(s),
                        h &&
                          ...
                          o.ordinal &&
                            0 === e.indexOf(i) &&
                            a.push(s + e.replace(i, this.options.pluralSeparator)),
                          p && a.push(s + t)));
                    }
                  }
                  for (; (r = a.pop()); )
                    this.isValidLookup(t) || ((i = r), (t = this.getResource(s, e, r, o)));
                }));
            });
          }),
          { res: t, usedKey: s, exactUsedKey: i, usedLng: n, usedNS: r }
        );
      }
      isValidLookup(e) {
        return (
    ...
    class S {
      ...
      getScriptPartFromCode(e) {
        if (!(e = f(e)) || 0 > e.indexOf("-")) return null;
        let t = e.split("-");
          ...
          return (
            this.options.lowerCaseLng
              ...
              : 2 === s.length
                ? ((s[0] = s[0].toLowerCase()),
                  (s[1] = s[1].toUpperCase()),
                  t.indexOf(s[1].toLowerCase()) > -1 && (s[1] = x(s[1].toLowerCase())))
                : 3 === s.length &&
                  ((s[0] = s[0].toLowerCase()),
                  2 === s[1].length && (s[1] = s[1].toUpperCase()),
                  "sgn" !== s[0] && 2 === s[2].length && (s[2] = s[2].toUpperCase()),
                  t.indexOf(s[1].toLowerCase()) > -1 && (s[1] = x(s[1].toLowerCase())),
                  t.indexOf(s[2].toLowerCase()) > -1 && (s[2] = x(s[2].toLowerCase()))),
            s.join("-")
          );
        }
            ...
            !t &&
              ...
              e.forEach((e) => {
                ...
                t = this.options.supportedLngs.find((e) => {
                  if (
                    e === s ||
                    (!(0 > e.indexOf("-") && 0 > s.indexOf("-")) && 0 === e.indexOf(s))
                  )
                    return e;
                });
              }),
    ...
    class R {
        ...
        ((this.languageUtils = e),
          ...
          (this.rules = (function () {
            ...
            return (
              k.forEach((t) => {
                t.lngs.forEach((s) => {
                  e[s] = { numbers: t.nr, plurals: L[t.fc] };
                });
              }),
              e
            );
      ...
      getRule(e) {
        ...
        if (this.shouldUseIntlApi())
          try {
            return new Intl.PluralRules(f(e), { type: t.ordinal ? "ordinal" : "cardinal" });
          } catch {
            return;
          }
    ...
    function $(e, t, s) {
      let i,
        ...
        o = void 0 !== (i = u(e, s)) ? i : u(t, s);
      return (
        !o && r && "string" == typeof s && void 0 === (o = d(e, s, n)) && (o = d(t, s, n)),
        o
      );
    }
    class C {
      ...
      init() {
        ...
        ((this.escape = void 0 !== t.escape ? t.escape : g),
          ...
          (this.prefix = t.prefix ? h(t.prefix) : t.prefixEscaped || "{{"),
          (this.suffix = t.suffix ? h(t.suffix) : t.suffixEscaped || "}}"),
          (this.formatSeparator = t.formatSeparator ? t.formatSeparator : t.formatSeparator || ","),
          (this.unescapePrefix = t.unescapeSuffix ? "" : t.unescapePrefix || "-"),
          (this.unescapeSuffix = this.unescapePrefix ? "" : t.unescapeSuffix || ""),
          (this.nestingPrefix = t.nestingPrefix
            ? h(t.nestingPrefix)
            : t.nestingPrefixEscaped || h("$t(")),
          (this.nestingSuffix = t.nestingSuffix
            ? h(t.nestingSuffix)
            : t.nestingSuffixEscaped || h(")")),
      ...
      interpolate(e, t, s, i) {
        ...
        let h = (e) => {
          if (0 > e.indexOf(this.formatSeparator)) {
            let n = $(t, l, e, this.options.keySeparator, this.options.ignoreJSONStructure);
          ...
          return this.format(
            $(t, l, r, this.options.keySeparator, this.options.ignoreJSONStructure),
            o,
            s,
            { ...i, ...t, interpolationkey: r }
          );
        };
        this.resetRegExp();
        let p = (i && i.missingInterpolationHandler) || this.options.missingInterpolationHandler,
          g =
        ...
        return (
          [
            ...
            { regex: this.regexp, safeValue: (e) => (this.escapeValue ? u(this.escape(e)) : u(e)) },
          ].forEach((t) => {
            for (a = 0; (n = t.regex.exec(e)); ) {
              ...
              if (
                ((e = e.replace(n[0], l)),
                g
                  ? ((t.regex.lastIndex += r.length), (t.regex.lastIndex -= n[0].length))
                  : (t.regex.lastIndex = 0),
                ++a >= this.maxReplaces)
              )
                break;
      ...
      nest(e, t) {
        ...
        function a(e, t) {
          ...
          if (0 > e.indexOf(s)) return e;
          let i = e.split(RegExp(`${s}[ ]*{`)),
            r = `{${i[1]}`;
          e = i[0];
          let o = (r = this.interpolate(r, n)).match(/'/g),
            a = r.match(/"/g);
          ...
          return (delete n.defaultValue, e);
        }
        for (; (s = this.nestingRegexp.exec(e)); ) {
          let l = [];
          (((n =
            (n = { ...r }).replace && "string" != typeof n.replace
              ? n.replace
              : n).applyPostProcessor = !1),
            delete n.defaultValue);
          let u = !1;
          if (-1 !== s[0].indexOf(this.formatSeparator) && !/{.*}/.test(s[1])) {
            let e = s[1].split(this.formatSeparator).map((e) => e.trim());
            ((s[1] = e.shift()), (l = e), (u = !0));
          }
          if ((i = t(a.call(this, s[1].trim(), n), n)) && s[0] === e && "string" != typeof i)
            return i;
          ("string" != typeof i && (i = o(i)),
            i || (this.logger.warn(`missed to resolve ${s[1]} for nesting ${e}`), (i = "")),
            u &&
              (i = l.reduce(
                (e, t) => this.format(e, t, r.lng, { ...r, interpolationkey: s[1].trim() }),
                i.trim()
              )),
            (e = e.replace(s[0], i)),
    ...
    function P(e) {
      ...
      return function (s, i, n) {
        let r = i + JSON.stringify(n),
          o = t[r];
        return (o || ((o = e(i, n)), (t[r] = o)), o(s));
      };
    }
    class j {
      constructor() {
      ...
      format(e, t, s) {
        ...
        return t.split(this.formatSeparator).reduce((e, t) => {
          let { formatName: n, formatOptions: r } = (function (e) {
                ...
                : "relativetime" === t && 0 > n.indexOf(":")
                  ...
                  : n.split(";").forEach((e) => {
                      ...
                      (s[t.trim()] || (s[t.trim()] = n),
                        "false" === n && (s[t.trim()] = !1),
                        "true" === n && (s[t.trim()] = !0),
                        isNaN(n) || (s[t.trim()] = parseInt(n, 10)));
                    });
            }
          ...
          if (this.formats[n]) {
            ...
            try {
              let o = (i && i.formatParams && i.formatParams[i.interpolationkey]) || {},
                a = o.locale || o.lng || i.locale || i.lng || s;
              t = this.formats[n](e, a, { ...r, ...i, ...o });
            } catch (e) {
              this.logger.warn(e);
            }
            return t;
    ...
    class E extends n {
      ...
      loaded(e, t, s) {
        ...
        (t && this.emit("failedLoading", n, r, t),
          s && this.store.addResourceBundle(n, r, s),
          (this.state[e] = t ? -1 : 2));
        let o = {};
      ...
      read(e, t, s) {
        ...
        let o = (o, a) => {
            ...
            o && a && i < this.maxRetries
              ? setTimeout(() => {
                  this.read.call(this, e, t, s, i + 1, 2 * n, r);
                }, n)
              : r(o, a);
          },
      ...
      loadOne(e) {
        let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "",
          ...
          i = s[0],
          n = s[1];
        this.read(i, n, "read", void 0, void 0, (s, r) => {
          (s && this.logger.warn(`${t}loading namespace ${n} for language ${i} failed`, s),
            !s && r && this.logger.log(`${t}loaded namespace ${n} for language ${i}`, r),
            this.loaded(e, s, r));
        });
      }
    ...
    class A extends n {
      ...
      init() {
        ...
        if (
          ((this.options = { ...n, ...this.options, ...I(t) }),
          "v1" !== this.options.compatibilityAPI &&
          ...
          (this.modules.logger
            ...
            this.modules.formatter ? (t = this.modules.formatter) : "u" > typeof Intl && (t = j));
          let s = new S(this.options);
          this.store = new m(this.options.resources, this.options);
          let r = this.services;
          ((r.logger = i),
            (r.resourceStore = this.store),
            (r.languageUtils = s),
            (r.pluralResolver = new R(s, {
            ...
            (r.interpolator = new C(this.options)),
            (r.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
            (r.backendConnector = new E(o(this.modules.backend), r.resourceStore, r, this.options)),
            r.backendConnector.on("*", function (t) {
              for (var s = arguments.length, i = Array(s > 1 ? s - 1 : 0), n = 1; n < s; n++)
                i[n - 1] = arguments[n];
              e.emit(t, ...i);
            }),
            this.modules.languageDetector &&
              ((r.languageDetector = o(this.modules.languageDetector)),
              r.languageDetector.init &&
                r.languageDetector.init(r, this.options.detection, this.options)),
            this.modules.i18nFormat &&
              ((r.i18nFormat = o(this.modules.i18nFormat)),
      ...
      loadResources(e) {
        ...
        if (
          ...
          if (i && "cimode" === i.toLowerCase()) return s();
          let e = [],
            t = (t) => {
              t &&
      ...
      changeLanguage(e, t) {
        ...
        let n = (e) => {
          ...
          a = (t) => {
            ...
            let s = "string" == typeof t ? t : this.services.languageUtils.getBestMatchFromCodes(t);
            (s &&
              (this.language || n(s),
      ...
      getFixedT(e, t, s) {
        ...
        let n = function (e, t) {
          ...
          ((r.lng = r.lng || n.lng),
            ...
            (r.ns = r.ns || n.ns),
            (r.keyPrefix = r.keyPrefix || s || n.keyPrefix));
          let h = i.options.keySeparator || ".";
          return (
            (o =
              r.keyPrefix && Array.isArray(e)
                ? e.map((e) => `${r.keyPrefix}${h}${e}`)
                : r.keyPrefix
                  ? `${r.keyPrefix}${h}${e}`
                  : e),
            i.t(o, r)
      ...
      cloneInstance() {
        ...
        return (
          ...
          s && ((n.store = new m(this.store.data, i)), (n.services.resourceStore = n.store)),
          (n.translator = new b(n.services, i)),
