...
function ct(e) {
  return (t, r, n) => {
    ...
    let o = De[t].replace("{{count}}", String(r));
...
function X({
  ...
  let w = q.default.useRef(null),
    { triggerProps: E, tooltipProps: I } = H({
      triggerRef: w,
      disabled: !o,
      tint: n || t ? V.tooltipBackground : void 0,
    }),
    b = t ? void 0 : ce(e.color || 0, x),
    { initials: ee, avatar: D, name: te } = e.user,
    U = ie(e, !t);
...
var le = q.default.forwardRef(function ({ children: t, className: r, ...n }, o) {
  return (0, l.jsx)("div", { ref: o, ...n, className: k(r), children: q.default.Children.only(t) });
});
var A = m(M(), 1);
var Oe = "l1l8om57",
  je = "sv36qp8",
  ...
  yt = A.default.memo(function ({
    ...
    let j = A.default.useRef(null),
      ...
      { triggerProps: Je, tooltipProps: Ge } = H({
        triggerRef: j,
        disabled: !v,
        tint: Te || n ? V.tooltipBackground : void 0,
      });
    return (0, d.jsxs)("div", {
      className: k(Oe, w && je, p),
      children: [
        te &&
          (0, d.jsxs)(d.Fragment, {
            children: [
...
function ht(e) {
  return typeof e.versionHostname == "string";
}
function gt(e) {
...
function At({ children: e }) {
  return e ? (0, J.jsx)(O.Suspense, { fallback: (0, J.jsx)(Tt, {}), children: e }) : null;
}
var Pt = "pvu3uy5";
function pe(e) {
...
var _e = { aiCredits: "Monthly Credits", contentEditors: "Content Editor Seat" };
function Ct(e) {
  return _e[e];
}
function St(e) {
...
function Mt({ acl: e, activeIds: t, userId: r }) {
  return (0, He.useMemo)(() => {
    let n = [],
      o = [],
      s = [],
      a = null;
    Array.from(e).sort(Nt);
    for (let p of e)
      p.kind === "invite"
        ? s.push(p)
        : p.user.id === r
...
var Ht = /^[a-z0-9-]+:\/\//i,
  Wt = /^[a-z0-9-]+:(?!\/\/)/i,
  Kt = new Set(["http://", "https://"]);
function Q(e) {
  let t = Ht.exec(e);
  return t ? t[0] : "";
}
function Yt(e) {
  if (Wt.test(e)) return !0;
  let t = Q(e);
  return t ? !Kt.has(t) : !1;
}
var qt = N("extractDomainAndPathnameFromUrl");
function Xt(e) {
  try {
    let t = Q(e),
    ...
    return (qt.reportError(t, { url: e }), { protocol: "", hostname: "", port: "", pathname: "" });
  }
}
function $t() {
  var e =
...
function Ye(e, t, r) {
  ...
  return ((n.onupgradeneeded = () => n.result.createObjectStore(t)), g(n));
}
function Jt(e, t) {
  let r = Ke()
    .then(() => Ye(e, t))
...
var me;
function P() {
  return (me || (me = Jt("keyval-store", "keyval")), me);
}
function qe(e, t = P()) {
  return t("readonly", (r) => g(r.get(e)));
}
function Xe(e, t, r = P()) {
  return r("readwrite", (n) => (n.put(t, e), g(n.transaction)));
}
function Fn(e, t = P()) {
  return t("readwrite", (r) => (e.forEach((n) => r.put(n[1], n[0])), g(r.transaction)));
}
function Rn(e, t = P()) {
  return t("readonly", (r) => Promise.all(e.map((n) => g(r.get(n)))));
}
function Z(e, t = P()) {
  return t("readwrite", (r) => (r.delete(e), g(r.transaction)));
}
function On(e, t = P()) {
  return t("readwrite", (r) => (e.forEach((n) => r.delete(n)), g(r.transaction)));
}
function Gt(e, t) {
  return e(
    "readonly",
...
function jn(e = P()) {
  let t = [];
  return Gt(e, (r) => t.push(r.key)).then(() => t);
}
var C = class e {
  constructor(t) {
    i(this, "scopes");
  ...
  xe = class {
    ...
    hasAccessTokenExpired() {
      return this._accessTokenExpiry
        ? new Date().getTime() >= this._accessTokenExpiry.getTime() - tr
        : !1;
    }
    isAccessTokenValid() {
...
//# sourceMappingURL=chunk-WGS5WK5D.mjs.map
