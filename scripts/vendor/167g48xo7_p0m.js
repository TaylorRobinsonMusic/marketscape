(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
          ...
          if (S(t))
            ...
            typeof (_ =
              null === (l = t) || "object" != typeof l
                ? null
                : "function" == typeof (l = (E && l[E]) || l["@@iterator"])
                  ? l
                  : null)
          )
  ...
  (e, t, r) => {
    ...
    function i(e, t) {
      for (let [r, i] of Object.entries(t)) {
        ...
        let c = n[r] || r.toLowerCase();
        ("SCRIPT" === e.tagName && u(c) ? (e[c] = !!i) : e.setAttribute(c, String(i)),
          (!1 === i || ("SCRIPT" === e.tagName && u(c) && (!i || "false" === i))) &&
  ...
  (e, t, r) => {
    ...
    let u = {
      ...
      a = /[&"'<>]/g;
    function s(e) {
      return e.replace(i, (e) => u[e]);
    }
    function l(e) {
      return e.replace(a, (e) => c[e]);
    }
  },
  479520,
  (e, t, r) => {
    ...
    let u = e.r(555682),
      ...
      g = (e) => {
        ...
        (u
          ? ((g.innerHTML = u.__html || ""), p())
          : i
            ? ((g.textContent = "string" == typeof i ? i : Array.isArray(i) ? i.join("") : ""), p())
            : t && ((g.src = t), y.set(t, E)),
          (0, f.setAttributesFromProps)(g, e),
          "worker" === c && g.setAttribute("type", "text/partytown"),
          g.setAttribute("data-nscript", c),
          l &&
            ((e) => {
    ...
    function h(e) {
      ...
      (0, s.useEffect)(() => {
        let e = t || r;
        O.current || (o && e && _.has(e) && o(), (O.current = !0));
      }, [o, t, r]);
      let R = (0, s.useRef)(!1);
      if (
        ((0, s.useEffect)(() => {
          if (!R.current) {
            if ("afterInteractive" === u) g(e);
            else
              "lazyOnload" === u &&
        ...
        ("beforeInteractive" === u || "worker" === u) &&
          (E
            ? ((b[u] = (b[u] || []).concat([
                { id: t, src: r, onLoad: n, onReady: o, onError: i, ...y, nonce: m },
              ])),
              E(b))
            : h && h()
              ? _.add(t || r)
          ...
          if (!r)
            ...
            return (
              a.default.preload(
                r,
                y.integrity
                  ? { as: "script", integrity: y.integrity, nonce: m, crossOrigin: y.crossOrigin }
                  : { as: "script", nonce: m, crossOrigin: y.crossOrigin }
              ),
              (0, c.jsx)("script", {
                nonce: m,
                dangerouslySetInnerHTML: {
