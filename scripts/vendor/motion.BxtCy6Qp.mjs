import { r as e, t } from "./rolldown-runtime.BB3S47xo.mjs";
import {
  A as n,
  C as r,
  F as i,
...
function Pe(e, t, n, r, i) {
  let a,
    o,
    s = 0;
  do ((o = t + (n - t) / 2), (a = Gs(o, r, i) - e), a > 0 ? (n = o) : (t = o));
  while (Math.abs(a) > Ks && ++s < qs);
  return o;
}
function Fe(e, t, n, r) {
  if (e === t && n === r) return I;
  let i = (t) => Pe(t, 0, 1, e, n);
  return (e) => (e === 0 || e === 1 ? e : Gs(i(e), t, r));
}
function Ie(e, t) {
  return oc(e) ? e[Ws(0, e.length, t)] : e;
}
function Le(e, t) {
  let n = new Set(),
    r = new Set(),
...
function Re(e, t) {
  let n = !1,
    ...
    a = () => (n = !0),
    o = dc.reduce((e, n) => ((e[n] = Le(a, t ? n : void 0)), e), {}),
    {
      setup: s,
      read: c,
      resolveKeyframes: l,
    ...
    h = () => {
      ...
      ((n = !1),
        a || (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, fc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
  ...
  return {
    schedule: dc.reduce((e, t) => {
      let r = o[t];
      return ((e[t] = (e, t = !1, i = !1) => (n || g(), r.schedule(e, t, i))), e);
    }, {}),
    cancel: (e) => {
      for (let t = 0; t < dc.length; t++) o[dc[t]].cancel(e);
    },
    state: i,
    steps: o,
  };
...
function Ue(e) {
  return (
    isNaN(e) && typeof e == `string` && (e.match(Tc)?.length || 0) + (e.match(zc)?.length || 0) > 0
  );
}
function We(e) {
  let t = e.toString(),
  ...
  return {
    ...
    split: t
      .replace(
        ...
        (e) => (
          K.test(e)
            ? (r.color.push(a), i.push(Vc), n.push(K.parse(e)))
            : e.startsWith(Uc)
              ? (r.var.push(a), i.push(Hc), n.push(e))
              : (r.number.push(a), i.push(Bc), n.push(parseFloat(e))),
          ++a,
          Wc
        )
      )
...
function Ke({ split: e, types: t }) {
  ...
  return (r) => {
    ...
    for (let a = 0; a < n; a++)
      if (((i += e[a]), r[a] !== void 0)) {
        let e = t[a];
        e === Bc ? (i += wc(r[a])) : e === Vc ? (i += K.transform(r[a])) : (i += r[a]);
      }
    return i;
  };
}
...
function Je(e) {
  let t = We(e);
  return Ke(t)(t.values.map((e, n) => qc(e, t.split[n])));
}
function Ye(e, t, n) {
  return (
    n < 0 && (n += 1),
...
function ot(e) {
  let t = 0,
    n = e.next(t);
  for (; !n.done && t < tl; ) ((t += 50), (n = e.next(t)));
  return t >= tl ? 1 / 0 : t;
}
...
function ut({
  ...
  let i, a;
  Is(e <= L(Y.maxDuration), `Spring duration must be 10 seconds or less`, `spring-duration-limit`);
  let o = 1 - t;
...
function pt(e = Y.visualDuration, t = Y.bounce) {
  ...
  let w = {
    ...
    toString: () => {
      let e = Math.min(ot(w), tl),
        t = el((t) => w.next(e * t).value, e, 30);
      return e + `ms ` + t;
    },
    toTransition: () => {},
  };
...
function gt(e, t, n) {
  ...
  for (let n = 0; n < a; n++) {
    let a = i(e[n], e[n + 1]);
    (t && (a = Bs(Array.isArray(t) ? t[n] || I : t, a)), r.push(a));
  }
  return r;
}
...
function wt(e) {
  typeof e.type == `string` && (e.type = ll[e.type]);
}
function Tt(e) {
  return new fl(e);
}
...
function jt() {
  if (Al) {
    let e = Array.from(Ol).filter((e) => e.needsMeasurement),
  ...
  ((Al = !1), (kl = !1), Ol.forEach((e) => e.complete(jl)), Ol.clear());
}
function Mt() {
  Ol.forEach((e) => {
...
function Pt(e, t, n) {
  Nl(t) ? e.style.setProperty(t, n) : (e.style[t] = n);
}
function Ft(e, t) {
  let n = Ne(e);
  return () => Pl[t] ?? n();
...
function Lt(
  ...
  c && (u.offset = c);
  let d = It(s, i);
  (Array.isArray(d) && (u.easing = d), z.value && hc.waapi++);
  let f = {
    delay: r,
    duration: i,
...
function zt({ type: e, ...t }) {
  return Rt(e) && Ll() ? e.applyToOptions(t) : ((t.duration ??= 300), (t.ease ??= `easeOut`), t);
}
function Bt(e) {
  return e in Vl;
}
function Vt(e) {
  typeof e.ease == `string` && Bt(e.ease) && (e.ease = Vl[e.ease]);
}
function Ht(e) {
  ((e.duration = 0), (e.type = `keyframes`));
}
function Ut(e) {
  for (let t = 0; t < e.length; t++) if (typeof e[t] == `string` && Gl.test(e[t])) return !0;
  return !1;
}
function Wt(e) {
  let {
...
function Xt(e, t, n = 1) {
  ...
  if (a) {
    let e = a.trim();
    return Ls(e) ? parseFloat(e) : e;
  }
  return yc(i) ? Xt(i, t, n + 1) : i;
}
function Zt(e, t) {
  if (e?.inherit && t) {
    let { inherit: n, ...r } = e;
...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in s) {
    ...
    r.start(su(t, r, i, m && cu.has(t) ? { type: !1 } : o, e, p));
    let h = r.animation;
    h && d.push(h);
  }
  if (o) {
...
function _n(e, t) {
  let n = Du(e);
  return (Ou.has(n) || (n = q), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0);
}
function vn(e) {
  return typeof e == `number` ? e === 0 : e === null ? !0 : e === `none` || e === `0` || zs(e);
}
function yn(e, t, n) {
  let r = 0,
    i;
  for (; r < e.length && !i; ) {
    let t = e[r];
    (typeof t == `string` && !ku.has(t) && We(t).values.length && (i = e[r]), r++);
  }
...
function xn(e) {
  return Rs(e) && `offsetHeight` in e && !(`ownerSVGElement` in e);
}
function Sn() {
  return Z.x || Z.y;
}
...
function Mn(e, t, n = {}) {
  let [r, i, a] = wn(e, n),
    o = (e) => {
      ...
      if (!jn(e) || Bu.has(e)) return;
      (Ru.add(r), n.stopPropagation && Bu.add(e));
      let a = t(r, e),
        o = (e, t) => {
          (T.removeEventListener(`pointerup`, s),
            T.removeEventListener(`pointercancel`, c),
            Ru.has(r) && Ru.delete(r),
            jn(e) && typeof a == `function` && a(e, { success: t }));
        },
        s = (e) => {
          o(e, r === T || r === document || n.useGlobalTarget || Pu(r, e.target));
        },
        c = (e) => {
          o(e, !1);
        };
  ...
  return (
    r.forEach((e) => {
      ((n.useGlobalTarget ? T : e).addEventListener(`pointerdown`, o, i),
        xn(e) &&
          (e.addEventListener(`focus`, (e) => zu(e, i)),
...
function In() {
  typeof ResizeObserver > `u` || (Hu = new ResizeObserver(Fn));
}
function Ln(e, t) {
  Hu || In();
  let n = bn(e);
  return (
    n.forEach((e) => {
      let n = Vu.get(e);
      (n || ((n = new Set()), Vu.set(e, n)), n.add(t), Hu?.observe(e));
    }),
    () => {
      n.forEach((e) => {
        let n = Vu.get(e);
        (n?.delete(t), n?.size || Hu?.unobserve(e));
      });
    }
  );
}
  ...
  return (
    ...
    () => {
      (Ku.delete(e),
        !Ku.size &&
          typeof qu == `function` &&
          (T.removeEventListener(`resize`, qu), (qu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function $n(e) {
  return Zn(e.animate) || td.some((t) => Qn(e[t]));
}
function er(e) {
...
function _r(e, t, n, r = !1) {
  ...
  (t.x < dd && t.x > ud && (t.x = 1), t.y < dd && t.y > ud && (t.y = 1));
}
function O(e, t) {
  ((e.min += t), (e.max += t));
}
...
function Dr(e) {
  for (let t in e) ((gd[t] = e[t]), _c(t) && (gd[t].isCSSVariable = !0));
}
function Or(e, { layout: t, layoutId: n }) {
  return (
    Cl.has(e) || e.startsWith(`origin`) || ((t || n !== void 0) && (!!gd[e] || e === `opacity`))
  );
}
function kr(e, t, n) {
  let r = e.style,
...
function Nr(
  ...
  for (let e of xd) d[e] !== void 0 && ((f[e] = d[e]), delete d[e]);
  (t !== void 0 && (d.x = t),
    n !== void 0 && (d.y = n),
    r !== void 0 && (d.scale = r),
...
function Pr(e, t, n, r) {
  for (let n in (Tr(e, t, void 0, r), t.attrs)) e.setAttribute(Sd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
    if (X(e[n]) || X(t[n])) {
      let t = Sl.indexOf(n) === -1 ? n : `attr` + n.charAt(0).toUpperCase() + n.substring(1);
      r[t] = e[n];
    }
  return r;
}
...
function Kr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.scale >= kd && e.scale <= Ad) || isNaN(e.scale)) && (e.scale = 1),
    ((e.translate >= Md && e.translate <= Nd) || isNaN(e.translate)) && (e.translate = 0));
}
function qr(e, t, n, r) {
...
function ti(e, t, n, r) {
  (ei(e.x, t, Pd, n ? n.x : void 0, r ? r.x : void 0),
    ei(e.y, t, Fd, n ? n.y : void 0, r ? r.y : void 0));
}
function ni(e) {
...
function di(e, t, n, r, i, a) {
  i
    ? ((e.opacity = J(0, n.opacity ?? 1, Bd(r))), (e.opacityExit = J(t.opacity ?? 1, 0, Vd(r))))
  ...
  for (let i = 0; i < Ld; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || zd(o) === zd(s)
        ? ((e[a] = Math.max(J(Rd(o), Rd(s), r), 0)), (W.test(s) || W.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function bi({
  ...
  return class {
    constructor(e = {}, n = t?.()) {
      ((this.id = Yd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            z.value && (Kd.nodes = Kd.calculatedTargetDeltas = Kd.calculatedProjections = 0),
            this.nodes.forEach(Ci),
            this.nodes.forEach(Mi),
            this.nodes.forEach(Ni),
            this.nodes.forEach(wi),
            z.addProjectionMetrics && z.addProjectionMetrics(Kd));
        }),
    ...
    addEventListener(e, t) {
      return (
        this.eventHandlers.has(e) || this.eventHandlers.set(e, new Hs()),
        ...
        (B.read(() => {
          ...
          e(t, () => {
            ...
            e !== r &&
              ...
              n && n(),
              (n = gi(i, 250)),
              Gd.hasAnimatedSinceResize &&
                ((Gd.hasAnimatedSinceResize = !1), this.nodes.forEach(ji)));
          }));
      }
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({ delta: e, hasLayoutChanged: t, hasRelativeLayoutChanged: n, layout: r }) => {
              ...
              let a = this.options.transition || i.getDefaultTransition() || Xd,
    ...
    resolveTargetDelta(e = !1) {
      ...
      (a &&
        ...
        !(!this.relativeTarget && !this.targetDelta) &&
          ...
          z.value && Kd.calculatedTargetDeltas++));
    }
    ...
    calcProjection() {
      ...
      (!this.projectionDelta || !this.prevProjectionDelta
        ...
        z.value && Kd.calculatedProjections++);
    }
    hide() {
      this.isVisible = !1;
    }
    ...
    createProjectionDeltas() {
      ((this.prevProjectionDelta = Zu()),
        (this.projectionDelta = Zu()),
        (this.projectionDeltaWithTransform = Zu()));
    }
        ...
        (this.pendingAnimation = B.update(() => {
          ((Gd.hasAnimatedSinceResize = !0),
            ...
            (this.currentAnimation = mi(this.motionValue, [0, 1e3], {
              ...
              onComplete: () => {
                (hc.layout--, e.onComplete && e.onComplete(), this.completeAnimation());
              },
            })),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Jd), this.currentAnimation.stop()),
    ...
    registerSharedNode(e, t) {
      (this.sharedNodes.has(e) || this.sharedNodes.set(e, new Wd()),
    ...
    resetSkewAndRotation() {
      ...
      for (let t = 0; t < qd.length; t++)
        (vi(`rotate${qd[t]}`, e, r, this.animationValues),
          vi(`skew${qd[t]}`, e, r, this.animationValues));
    ...
    applyProjectionStyles(e, t) {
      ...
      gd)) {
        ...
        let { correct: n, applyTo: o, isCSSVariable: s } = gd[t],
...
function ea() {
  if (mf) return;
  let e = {};
  for (let t in pf) e[t] = { isEnabled: (e) => pf[t].some((t) => !!e[t]) };
  (rr(e), (mf = !0));
}
function ta() {
  return (ea(), ir());
...
function ia(e) {
  typeof e == `function` && (gf = (t) => (t.startsWith(`on`) ? !ra(t) : e(t)));
}
function aa(e, t, n) {
  let r = {};
  for (let i in e)
...
function ua(e) {
  let { initial: t, animate: r } = la(e, n(_f));
...
function ga(e, t, n, r) {
  let i = v(() => {
    let n = xf();
    return (Nr(n, t, Cd(r), e.transformTemplate, e.style), { ...n.attrs, style: { ...n.style } });
  }, [t]);
  if (e.style) {
    let t = {};
...
function _a(e) {
  return typeof e != `string` || e.includes(`-`) ? !1 : !!(Sf.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
...
function Qa(e) {
  let [t, r] = Xi(),
    i = n(Ms);
  return h(Uf, { ...e, layoutGroup: i, switchLayoutGroup: n(yf), isPresent: t, safeToRemove: r });
}
function $a(e, t, n) {
  let { props: r } = e;
...
function ao(e, t, n, r) {
  ...
  let l = r - c;
  i.velocity = l > ip ? 0 : Us(i.current - s, l);
}
function oo(e, t, n) {
...
function co(e, t, n = 0) {
  let r = 0;
  if ((e in cp && (e = cp[e]), typeof e == `string`)) {
    let t = parseFloat(e);
    e.endsWith(`px`)
      ? (r = t)
      : e.endsWith(`%`)
...
function lo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ? (i = [e, e])
      : typeof e == `string` &&
        ((e = e.trim()), (i = e.includes(` `) ? e.split(` `) : [e, cp[e] ? e : `0`])),
    (a = co(i[0], n, r)),
    (o = co(i[1], t)),
    a - o
  );
...
function ho(e, { container: t = document.scrollingElement, trackContentSize: n = !1, ...r } = {}) {
  ...
  if ((i.add(a), !fp.has(t))) {
    ...
    (T.addEventListener(`resize`, r),
      t !== document.documentElement && pp.set(t, Bn(t, r)),
  ...
  return (
    ...
    () => {
      ...
      (fp.delete(t),
        n &&
          (_p(t).removeEventListener(`scroll`, n),
          pp.get(t)?.(),
          T.removeEventListener(`resize`, n)));
      let r = gp.get(t);
      (r && (V(r), gp.delete(t)), hp.delete(t));
    }
  );
}
function go(e) {
  return T === void 0 ? !1 : e ? Il() : Fl();
}
function _o(e) {
...
function bo(e) {
  ...
  for (let [t, n] of vp) if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return T === void 0 ? !1 : e ? Il() && !!bo(t) : Fl();
}
...
function No(e) {
  ((du.current = []), e());
  let t = Mo(du.current, e);
  return ((du.current = void 0), t);
}
function Po(e, t, n, r) {
      ...
      _ = (e, n, r, o = 0, s = 0) => {
        ...
        if (
          ...
          m &&
            Is(
              m < Tp,
              `Sequence segments can't repeat ${m} times \u2014 ignoring repeat option. Use a value below ${Tp} or apply repeat at the sequence level instead.`
            ),
          m && m < Tp)
        ) {
          let e = b > 0 ? _ / b : 0;
          ...
          i &&
            ((a = [...t].reverse()),
            h === `reverse` &&
              (o = [...r].reverse().map((e) => (typeof e == `function` ? Ys(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
        ...
        let T = ee + b;
        (Zo(r, c, y, u, ee, T), (g = Math.max(x + b, g)), (f = Math.max(T, f)));
      };
    if (X(p)) {
      let e = ts(p, s);
      _(m, h, ns(`default`, e));
  ...
  return (
    s.forEach((e, r) => {
      for (let i in e) {
        ...
        (c[0] !== 0 && (c.unshift(0), s.unshift(s[0]), l.unshift(wp)),
...
function ps(e) {
  return typeof e == `object` && !!e && Tf in e;
}
function ms(e) {
  if (ps(e)) return e[Tf];
}
...
function gs(e) {
  tf.current && ((tf.current.isUpdating = !1), tf.current.blockUpdate(), e && e());
}
function _s() {
  return s(() => {
    let e = tf.current;
...
function vs(e, t, { root: n, margin: r, amount: i = `some` } = {}) {
  let a = bn(e),
    ...
    s = new IntersectionObserver(
      ...
      { root: n, rootMargin: r, threshold: typeof i == `number` ? i : Ap[i] }
    );
  return (a.forEach((e) => s.observe(e)), () => s.disconnect());
}
function ys(e, { root: t, margin: n, amount: r, once: a = !1, initial: o = !1 } = {}) {
  let [s, l] = i(o);
  return (
    c(() => {
...
function Cs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  ...
  return h(s, {
    ...
    ref: m,
    ignoreStrict: !0,
    children: h(Np.Provider, { value: p, children: e }),
  });
}
function ws(e, t) {
...
function Ts() {
  if (Bp) {
    let e = Ds(Bp, `y`);
    e && (zp.delete(e), Rp.delete(e));
    let t = Ds(Bp, `x`);
    (t && t !== e && (zp.delete(t), Rp.delete(t)), (Bp = null));
  }
}
function Es(e, t) {
...
function Os(e, t, n) {
  ...
  if (o < Fp) {
    let e = 1 - o / Fp;
    return { amount: -Ip * e * e, edge: `start` };
  } else if (s < Fp) {
    let e = 1 - s / Fp;
    return { amount: Ip * e * e, edge: `end` };
  }
...
function ks(e, t, n, r) {
  ...
  let i = Ds(e, n);
  if (!i) return;
  let { amount: a, edge: o } = Os(t - (n === `x` ? T.scrollX : T.scrollY), i, n);
  if (o === null) {
    (zp.delete(i), Rp.delete(i));
    return;
  }
  let s = zp.get(i),
...
function js(
  ...
  return h(u, {
    ...
    onDrag: (e, t) => {
      ...
      (_(r, f[m].get(), n[m]), ks(v.current, i[m], m, n[m]), a && a(e, t));
    },
    onDragEnd: (e, t) => {
      (Ts(), o && o(e, t));
    },
...
var Ms,
  ...
  Hp = t(() => {
    (o(),
      ...
      (F = {}),
      (Ls = (e) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(e)),
      (Rs = (e) => typeof e == `object` && !!e),
      (zs = (e) => /^0[^.\s]+$/u.test(e)),
      (I = (e) => e),
      (Bs = (...e) => e.reduce((e, t) => (n) => t(e(n)))),
      (Vs = (e, t, n) => {
        let r = t - e;
        return r ? (n - e) / r : 1;
      }),
      ...
      (Gs = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
      (Ks = 1e-7),
      (qs = 12),
      (Js = (e) => (t) => (t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2)),
      (Ys = (e) => (t) => 1 - e(1 - t)),
      (Xs = Fe(0.33, 1.53, 0.69, 0.99)),
      (Zs = Ys(Xs)),
      (Qs = Js(Zs)),
      ($s = (e) => (e >= 1 ? 1 : (e *= 2) < 1 ? 0.5 * Zs(e) : 0.5 * (2 - 2 ** (-10 * (e - 1))))),
      ...
      (uc = (e) => {
        if (sc(e)) {
          ...
          return (P(cc[e] !== void 0, `Invalid easing type '${e}'`, `invalid-easing-type`), cc[e]);
        return e;
      }),
      ...
      (U = {
        ...
        set: (e) => {
          ((mc = e), queueMicrotask(ze));
        },
      }),
      (hc = { layout: 0, mainThread: 0, waapi: 0 }),
      ...
      (Mc = { test: Dc(`#`), parse: He, transform: jc.transform }),
      (Nc = (e) => ({
      ...
      (K = {
        test: (e) => jc.test(e) || Mc.test(e) || Rc.test(e),
        parse: (e) => (jc.test(e) ? jc.parse(e) : Rc.test(e) ? Rc.parse(e) : Mc.parse(e)),
        transform: (e) =>
          typeof e == `string` ? e : e.hasOwnProperty(`red`) ? jc.transform(e) : Rc.transform(e),
        getAnimatableNone: (e) => {
          let t = K.parse(e);
      ...
      (Kc = (e) => (typeof e == `number` ? 0 : K.test(e) ? K.getAnimatableNone(e) : e)),
      (qc = (e, t) => (typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Kc(e))),
      ...
      (Zc = (e, t) => {
        ...
        let i = { ...n };
        return (e) => (
          (i.red = Jc(n.red, r.red, e)),
          (i.green = Jc(n.green, r.green, e)),
          (i.blue = Jc(n.blue, r.blue, e)),
      ...
      (ll = { decay: ht, inertia: ht, tween: St, keyframes: St, spring: pt }),
      (ul = class {
        constructor() {
          this.updateFinished();
        }
      ...
      (fl = class extends ul {
        ...
        initAnimation() {
          ...
          s !== St &&
            typeof o[0] != `number` &&
            ((this.mixKeyframes = Bs(dl, at(o[0], o[1]))), (o = [0, 100]));
        ...
        play() {
          ...
          let { driver: e = cl, startTime: t } = this.options;
      ...
      (hl = {
        ...
        rotate: ml,
        rotateZ: ml,
        skewX: (e) => pl(Math.atan(e[1])),
        skewY: (e) => pl(Math.atan(e[2])),
        skew: (e) => (Math.abs(e[1]) + Math.abs(e[2])) / 2,
      }),
      (gl = (e) => ((e %= 360), e < 0 && (e += 360), e)),
      (_l = ml),
      (vl = (e) => Math.sqrt(e[0] * e[0] + e[1] * e[1])),
      (yl = (e) => Math.sqrt(e[4] * e[4] + e[5] * e[5])),
      (bl = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: yl,
        scale: (e) => (vl(e) + yl(e)) / 2,
        rotateX: (e) => gl(pl(Math.atan2(e[6], e[5]))),
        rotateY: (e) => gl(pl(Math.atan2(-e[2], e[0]))),
        rotateZ: _l,
        rotate: _l,
        skewX: (e) => pl(Math.atan(e[4])),
        skewY: (e) => pl(Math.atan(e[1])),
      ...
      (Ml = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Ol.add(this), kl || ((kl = !0), B.read(Mt), B.resolveKeyframes(jt)))
        ...
        cancel() {
          this.state === `scheduled` && (Ol.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (Nl = (e) => e.startsWith(`--`)),
      (Pl = {}),
      (Fl = Ft(() => T.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Il = Ft(() => T.ViewTimeline !== void 0, `viewTimeline`)),
      (Ll = Ft(() => {
        try {
      ...
      (Rl = ([e, t, n, r]) => `cubic-bezier(${e}, ${t}, ${n}, ${r})`),
      (zl = {
        linear: `linear`,
        ease: `ease`,
        easeIn: `ease-in`,
      ...
      (Vl = { anticipate: $s, backInOut: Qs, circInOut: nc }),
      (Hl = 10),
      (Ul = class extends Bl {
        constructor(e) {
          (Vt(e),
        ...
        updateMotionValue(e) {
          ...
          let o = new fl({ ...a, autoplay: !1 }),
            s = Math.max(Hl, U.now() - this.startTime),
            c = N(0, Hl, s - Hl),
            l = o.sample(s).value,
            { name: u } = this.options;
          (i && u && Pt(i, u, l),
      ...
      (Gl = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/),
      (Kl = new Set([
        `color`,
        `backgroundColor`,
        `outlineColor`,
      ...
      (ql = Ne(() => Object.hasOwnProperty.call(Element.prototype, `animate`))),
      (Jl = (e, t) =>
        t === `zIndex`
          ? !1
          : !!(
      ...
      (Xl = class extends ul {
        constructor({
          ...
          ((this.keyframeResolver = new (l?.KeyframeResolver || Ml)(
            o,
      ...
      (au = (e, { keyframes: t }) =>
        t.length > 2 ? ru : Cl.has(e) ? (e.startsWith(`scale`) ? nu(t[1]) : tu) : iu),
      (ou = new Set([
        `when`,
        `delay`,
        `delayChildren`,
      ...
      (su =
        ...
        (o) => {
          ...
          return s.isSync ? new fl(u) : new Xl(u);
        }),
      (cu = new Set([`width`, `height`, `top`, `left`, `right`, `bottom`, ...Sl])),
      (lu = 30),
      (uu = (e) => !isNaN(parseFloat(e))),
      (du = { current: void 0 }),
      (fu = class {
        constructor(e, t = {}) {
        ...
        setCurrent(e) {
          ((this.current = e),
            ...
            this.canTrackVelocity === null &&
              e !== void 0 &&
              (this.canTrackVelocity = uu(this.current)));
        }
        ...
        on(e, t) {
          this.events[e] || (this.events[e] = new Hs());
        ...
        get() {
          return (du.current && du.current.push(this), this.current);
        }
        getPrevious() {
          return this.prev;
        }
        getVelocity() {
          let e = U.now();
          if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > lu)
            return 0;
          let t = Math.min(this.updatedAt - this.prevUpdatedAt, lu);
          return Us(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
        }
        start(e) {
          return (
            this.stop(),
      ...
      (hu = `data-` + ln(mu)),
      (gu = (e) => (t) => t.test(e)),
      (_u = [xc, G, W, Pc, Ic, Fc, { test: (e) => e === `auto`, parse: (e) => e }]),
      (vu = (e) => _u.find(gu(e))),
      (yu = {
        rotate: Pc,
        rotateX: Pc,
      ...
      (Au = class extends Ml {
        ...
        readKeyframes() {
          ...
          if (a !== o)
            ...
            else Dl[n] && (this.needsMeasurement = !0);
        }
        ...
        measureInitialState() {
          ...
          (n === `height` && (this.suspendedScrollY = T.pageYOffset),
            (this.measuredOrigin = Dl[n](e.measureViewportBox(), T.getComputedStyle(e.current))),
        ...
        measureEndState() {
          ...
          let i = n.length - 1,
            a = n[i];
          ((n[i] = Dl[t](e.measureViewportBox(), T.getComputedStyle(e.current))),
      ...
      (ju = (e, t) => (t && typeof e == `number` ? t.transform(e) : e)),
      ({ schedule: Mu, cancel: Nu } = Re(queueMicrotask, !1)),
      (Z = { x: !1, y: !1 }),
      (Pu = (e, t) => (t ? (e === t ? !0 : Pu(e, t.parentElement)) : !1)),
      (Fu = (e) =>
        e.pointerType === `mouse`
          ? typeof e.button != `number` || e.button <= 0
          : e.isPrimary !== !1),
      (Iu = new Set([`BUTTON`, `INPUT`, `SELECT`, `TEXTAREA`, `A`])),
      (Lu = new Set([`INPUT`, `SELECT`, `TEXTAREA`])),
      (Ru = new WeakSet()),
      (zu = (e, t) => {
      ...
      (Wu = Uu(`inline`, `width`, `offsetWidth`)),
      (Gu = Uu(`block`, `height`, `offsetHeight`)),
      (Ku = new Set()),
      (Ju = [..._u, K, q]),
      (Yu = (e) => Ju.find(gu(e))),
      (Xu = () => ({ translate: 0, scale: 1, origin: 0, originPoint: 0 })),
      (Zu = () => ({ x: Xu(), y: Xu() })),
      (Qu = () => ({ min: 0, max: 0 })),
      (Q = () => ({ x: Qu(), y: Qu() })),
      ($u = new WeakMap()),
      ...
      (sd = class {
          ...
          ((this.current = e),
            ...
            this.reducedMotionConfig === `never`
              ...
              : this.reducedMotionConfig === `always`
                ...
                : (rd.current || nr(), (this.shouldReduceMotion = nd.current)),
        ...
        bindToMotionValue(e, t) {
          if (
            ...
            t.accelerate && Wl.has(e) && this.current instanceof HTMLElement)
          ) {
        ...
        readValue(e, t) {
          ...
          return (
            n != null &&
              (typeof n == `string` && (Ls(n) || zs(n))
                ? (n = parseFloat(n))
                : !Yu(n) && q.test(t) && (n = _n(e, t)),
        ...
        on(e, t) {
          return (this.events[e] || (this.events[e] = new Hs()), this.events[e].add(t));
        }
        notify(e, ...t) {
          this.events[e] && this.events[e].notify(...t);
        }
        scheduleRenderMicrotask() {
          Mu.render(this.render);
        }
      }),
      (cd = class extends sd {
        constructor() {
      ...
      (_d = class extends cd {
        ...
        readValueFromInstance(e, t) {
          if (Cl.has(t)) return this.projection?.isProjecting ? Dt(t) : xl(e, t);
          {
            let n = Ar(e),
      ...
      (yd = { offset: `stroke-dashoffset`, array: `stroke-dasharray` }),
      (bd = { offset: `strokeDashoffset`, array: `strokeDasharray` }),
      (xd = [`offsetDistance`, `offsetPath`, `offsetRotate`, `offsetAnchor`]),
      (Sd = new Set([
        `baseFrequency`,
        `diffuseConstant`,
        `kernelMatrix`,
      ...
      (Cd = (e) => typeof e == `string` && e.toLowerCase() === `svg`),
      (wd = class extends cd {
        constructor() {
          (super(...arguments),
            (this.type = `svg`),
        ...
        readValueFromInstance(e, t) {
          ...
          return ((t = Sd.has(t) ? t : ln(t)), e.getAttribute(t));
        }
        scrapeMotionValuesFromProps(e, t, n) {
          return Fr(e, t, n);
        }
      ...
      (zd = (e) => typeof e == `number` || G.test(e)),
      (Bd = pi(0, 0.5, tc)),
      (Vd = pi(0.5, 0.95, I)),
      (Hd = (e, t) => e.depth - t.depth),
      (Ud = class {
        constructor() {
      ...
      (Gd = { hasAnimatedSinceResize: !0, hasEverUpdated: !1 }),
      (Kd = { nodes: 0, calculatedTargetDeltas: 0, calculatedProjections: 0 }),
      (qd = [``, `X`, `Y`, `Z`]),
      (Jd = 1e3),
      (Yd = 0),
      (Xd = { duration: 0.45, ease: [0.4, 0, 0.1, 1] }),
      (Zd = (e) => d !== void 0 && d.userAgent && d.userAgent.toLowerCase().includes(e)),
      (Qd = Zd(`applewebkit/`) && !Zd(`chrome/`) ? Math.round : I),
      ($d = bi({
      ...
      (ef = (e) => !e.isLayoutDirty && e.willUpdate(!1)),
      (tf = { current: void 0 }),
      (nf = bi({
        ...
        defaultParent: () => {
          if (!tf.current) {
            let e = new $d({});
            (e.mount(T), e.setOptions({ layoutScroll: !0 }), (tf.current = e));
          }
          return tf.current;
        },
        resetTransform: (e, t) => {
      ...
      (af = ({
        ...
        return (
          ...
          h(Fs.Provider, { value: m, children: e })
        );
      }),
      (of = (e) => e.key || ``),
      (sf = ({
      ...
      (lf = (e) => e === !0),
      (uf = (e) => lf(e === !0) || e === `id`),
      (df = ({ children: e, id: t, inherit: r = !0 }) => {
        let i = n(Ms),
          a = n(cf),
          [o, s] = $i(),
          c = l(null),
        ...
        c.current === null &&
          (uf(r) && u && (t = t ? u + `-` + t : u),
          (c.current = { id: t, group: (lf(r) && i.group) || Wi() }));
        let d = v(() => ({ ...c.current, forceRender: o }), [s]);
        return h(Ms.Provider, { value: d, children: e });
      }),
      (ff = a({ strict: !1 })),
      (pf = {
        animation: [
    ...
    ((_f = a({})),
      ...
      (yf = a({})),
      (bf = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} })),
      (xf = () => ({ ...bf(), attrs: {} })),
      (Sf = [
        `animate`,
        `circle`,
      ...
      (Cf = vf({ scrapeMotionValuesFromProps: kr, createRenderState: bf })),
      (wf = vf({ scrapeMotionValuesFromProps: Fr, createRenderState: xf })),
      ...
      (kf = { animation: { Feature: Ef }, exit: { Feature: Of } }),
      (Af = (e) => (t) => Fu(t) && e(t, ka(t))),
      (jf = (e, t) => Math.abs(e - t)),
      (Mf = (e, t) => ((t.isSVG ?? _a(e)) ? new wd(t) : new _d(t, { allowProjection: e !== u }))),
      (Nf = ({ current: e }) => (e ? e.ownerDocument.defaultView : null)),
      (Pf = new Set([`auto`, `scroll`])),
      (Ff = class {
        constructor(
          e,
          t,
        ...
        startScrollTracking(e) {
          ...
          for (; t; ) {
            ...
            ((Pf.has(e.overflowX) || Pf.has(e.overflowY)) &&
      ...
      (Rf = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (cn(this.visualElement, e), n.start(su(e, n, 0, t, this.visualElement, !1)));
        }
        stopAnimation() {
      ...
      (Vf = class extends ld {
        ...
        onPointerDown(e) {
          this.session = new Ff(e, this.createPanHandlers(), {
      ...
      (Wf = { pan: { Feature: Vf }, drag: { Feature: zf, ProjectionNode: nf, MeasureLayout: Qa } }),
      (Gf = class extends ld {
        mount() {
      ...
      (tp = { layout: { ProjectionNode: nf, MeasureLayout: Qa } }),
      (np = Oa({ ...kf, ...ep, ...Wf, ...tp }, Mf)),
      (rp = { renderer: Mf, ...kf, ...ep }),
      { ...rp, ...Wf, ...tp },
      { ...kf },
      (ip = 50),
      (ap = () => ({
      ...
      (op = () => ({ time: 0, x: ap(), y: ap() })),
      (sp = { x: { length: `Width`, position: `Left` }, y: { length: `Height`, position: `Top` } }),
      (cp = { start: 0, center: 0.5, end: 1 }),
      (lp = [0, 0]),
      (up = {
        Enter: [
          [0, 1],
      ...
      (hp = new WeakMap()),
      (gp = new WeakMap()),
      (_p = (e) => (e === document.scrollingElement ? T : e)),
      (vp = [
        [up.Enter, `entry`],
        [up.Exit, `exit`],
        [up.Any, `cover`],
      ...
      (yp = { start: 0, end: 1 }),
      (bp = new Map()),
      (xp = () => ({ scrollX: D(0), scrollY: D(0), scrollXProgress: D(0), scrollYProgress: D(0) })),
      (Sp = (e) => (e ? !e.current : !1)),
      (Cp = class extends fu {
        constructor() {
        ...
        add(e) {
          (Cl.has(e) || Wl.has(e)) && ((this.isEnabled = !0), this.update());
        }
        update() {
      ...
      (Ap = { some: 0, all: 1 }),
      (jp = () => ({})),
      vf({ scrapeMotionValuesFromProps: jp, createRenderState: jp }),
      (Mp = {}),
      fe(Mp, { Group: () => Pp, Item: () => Vp }),
      (Np = a(null)),
      (Pp = m(Cs)),
      (Fp = 50),
      (Ip = 25),
      (Lp = new Set([`auto`, `scroll`])),
      (Rp = new WeakMap()),
      (zp = new WeakMap()),
      (Bp = null),
      (Vp = m(js)));
...
//# sourceMappingURL=motion.BxtCy6Qp.mjs.map
