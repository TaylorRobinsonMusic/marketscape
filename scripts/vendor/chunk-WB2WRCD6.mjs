...
var ff = Object.defineProperty,
  ...
  ua = (e, t, o) =>
    t in e ? ff(e, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (e[t] = o),
  C = (e, t) => {
...
function Ge(e) {
  ...
  return t === "button" ? !0 : t === "input" && e.type ? bf.indexOf(e.type) !== -1 : !1;
}
var bf = ["button", "color", "file", "image", "reset", "submit"];
function ao(e) {
...
function fo(e, t) {
  ...
  return (
    o.sort(([n, i], [s, a]) => {
      let u = t(i),
        c = t(a);
      return u === c || !u || !c ? 0 : hf(u, c) ? (n > s && (r = !0), -1) : (n < s && (r = !0), 1);
    }),
    r ? o.map(([n, i]) => i) : e
  );
}
...
var gf = H(X(), 1),
  ...
  di = C({}, gf),
  ba = di.useId,
  nv = di.useDeferredValue,
  ha = di.useInsertionEffect,
  Z = Ft ? pe.useLayoutEffect : pe.useEffect;
function xf(e) {
  let [t] = (0, pe.useState)(e);
  return t;
}
function un(e) {
  let t = (0, pe.useRef)(e);
...
function ln() {
  return (0, pe.useReducer)(() => [], []);
}
function ie(e) {
  return $(typeof e == "function" ? e : () => e);
}
function ue(e, t, o = []) {
  let r = (0, pe.useCallback)(
...
var mo = Pe(),
  Pa = mo.useContext,
  fv = mo.useScopedContext,
  mv = mo.useProviderContext,
  Ea = mo.ContextProvider,
  Ia = mo.ScopedContextProvider;
var vi = H(X(), 1),
  po = Pe([Ea], [Ia]),
  Vt = po.useContext,
  bv = po.useScopedContext,
...
function Ra(e, t, o = !1) {
  ...
  return [...e.slice(r + 1), ...(o ? [Cf] : []), ...e.slice(0, r)];
}
function Aa(e, t) {
...
var Lt = U(function (t) {
    ...
    ((0, Ze.useEffect)(() => {
      r && (Ua || (ye("mousedown", Ff, !0), ye("keydown", Hf, !0), (Ua = !0)));
    }, [r]),
      ja &&
        (0, Ze.useEffect)(() => {
          if (!r) return;
    ...
    let d = yi(a.onKeyPressCapture, c),
      ...
      E = $((I) => {
        ...
        let A = I.currentTarget,
          z = () => x(I, A);
        wi || Rf(I.target) ? bt(I.target, "focusout", z) : l(!1);
      }),
      S = a.onBlur,
      T = $((I) => {
    ...
    return (
      (a = R(
        ...
        ),
        {
          ref: ee(u, _, a.ref),
          style: D,
          tabIndex: _f(r, f, B, b, a.tabIndex),
...
var Tr = U(function (t) {
    ...
    let d = Re(m.id),
      ...
      _ = (0, Nt.useRef)(!1),
      F = $((M) => {
        if ((k?.(M), M.defaultPrevented || on(M) || !d || !r || Kf(M, r))) return;
        let { virtualFocus: V, baseElement: G } = r.getState();
        if (
          (r.setActiveId(d),
          uo(M.currentTarget) && Ta(M.currentTarget),
          !V || !ke(M) || Bf(M.currentTarget) || !G?.isConnected)
        )
          return;
        (Ht() &&
...
function eu(e, t, o) {
  return $((r) => {
    var n;
    if ((t?.(r), r.defaultPrevented || r.isPropagationStopped() || !ke(r) || qf(r) || $f(r)))
      return;
    let i = e.getState(),
...
var Co = U(function (t) {
  ...
  Jb = W(function (t) {
    ...
    let i = yo(),
      s = n.store || i;
    return ce(s, (u) => !r || u?.mounted) === !1 ? null : (0, Ei.jsx)(Qf, C({}, n));
  });
function So(e = {}) {
...
function nm(e, t, o = !1) {
  let r = e.findIndex((n) => n.id === t);
  return [...e.slice(r + 1), ...(o ? [rm] : []), ...e.slice(0, r)];
}
function pu(e) {
  let t = [];
  for (let o of e) {
...
function br(e = {}) {
  ...
  let a = (u = "next", c = {}) => {
    ...
    let l = s.getState(),
      ...
      S = E ? y && !w : !y || w,
      T = p && !d,
      k = w ? go(sm(pu(P), v, T)) : P;
    if (((k = S ? _r(k) : k), (k = w ? am(k) : k), v == null))
...
var Hi = U(function (t) {
    ...
    return (
      Z(() => {
        ...
        let E = w.isConnected;
        if (
          (E || (m || gm(y)).appendChild(w),
          w.id || (w.id = y.id ? `portal/${y.id}` : ym()),
          d(w),
          no(s, w),
          !E)
        )
...
function Pm(e, t, o) {
  return Cm.includes(t.tagName) || !Sm(e, t) ? !1 : !o.some((r) => r && le(t, r));
}
function Ao(e, t, o, r) {
  for (let n of t) {
    ...
    for (; n.parentElement && n !== s.body; ) {
      if ((r?.(n.parentElement, a), !i))
        for (let u of n.parentElement.children) Pm(e, u, t) && o(u, a);
      n = n.parentElement;
    }
  }
}
...
var st = Math.min,
  ...
  Ho = Math.floor,
  Wt = (e) => ({ x: e, y: e }),
  Fm = { left: "right", right: "left", bottom: "top", top: "bottom" },
...
function Gi(e) {
  return typeof e != "number" ? Lm(e) : { top: e, right: e, bottom: e, left: e };
}
function xr(e) {
...
function uc(e, t, o) {
  let r;
  if (t === "viewport") r = Um(e, o);
  else if (t === "document") r = zm(St(e));
  else if (at(t)) r = $m(t, o);
  else {
    let n = fc(e);
...
function Gm(e) {
  let { element: t, boundary: o, rootBoundary: r, strategy: n } = e,
    s = [...(o === "clippingAncestors" ? (Vo(t) ? [] : qm(t, this._c)) : [].concat(o)), r],
    a = s[0],
    u = s.reduce(
      (c, f) => {
        let m = uc(t, f, n);
...
function od(e, t) {
  return {
    ...
    getBoundingClientRect: () => {
      let r = e,
        n = t?.(r);
      return n || !r ? rd(n) : r.getBoundingClientRect();
    },
  };
}
function nd(e) {
...
function sd(e) {
  ...
  return (te(!t || t.every(nd), !1), gc({ padding: e.overflowPadding, fallbackPlacements: t }));
}
function ad(e) {
    ...
    (Z(() => {
      ...
      let J = od(T, V),
        he = async () => {
          ...
          let Ue = S || D.current,
            Xe = [
              id(Ue, { gutter: g, shift: m }),
              sd({ flip: f, overflowPadding: x }),
              ad({ slide: l, shift: m, overlap: d, overflowPadding: x }),
              cd(Ue, { arrowPadding: h }),
              ud({ sameWidth: v, fitViewport: p, overflowPadding: x }),
            ],
            Ne = await Cc(J, _, {
              placement: B,
...
var Mc = H(X(), 1),
  ...
  Sw = jo.useProviderContext,
  Pw = jo.ContextProvider,
  Ew = jo.ScopedContextProvider,
  Iw = (0, Mc.createContext)(void 0);
var vd = "div",
  Ko = U(function (t) {
    var o = t,
      { store: r } = o,
...
var zo = U(function (t) {
    ...
    let a = i.onKeyDownCapture,
      ...
      c = $((f) => {
        ...
        if ((x.length && (p = fo(p, (w) => w.element)), !Cd(f, p))) return is();
        (f.preventDefault(),
...
var Rd = (0, Fc.createContext)(void 0);
var Un = H(X(), 1),
  Hc = H(ve(), 1),
  Ad = "div";
function Dd(e) {
...
var Gd = U(function (t) {
        ...
        return (
          queueMicrotask(() => {
            ...
            (lo(we, Rt, He),
              (ne = () => {
                if (!nt(we)) return;
                let { start: sr, end: of } = Mr(we);
                sr === Rt && of === He && lo(we, Ie, rt);
              }));
          }),
          () => ne()
        );
    ...
    (ot(() => {
      ...
      if (!(Ie && !nt(Ie))) {
        ...
        if (k && we) {
          let He = G(I),
            sr = He !== void 0 ? He : (L = qd(I)) != null ? L : r.first();
    ...
    let J = (L) => L.currentTarget.value.length >= u,
      ...
      Ue = $((L) => {
        ...
        let ne = L.currentTarget,
          ...
          Rt = L.nativeEvent;
        if (
          ((S.current = !0), Ud(Rt) && (Rt.isComposing && ((S.current = !1), (T.current = !0)), _))
        ) {
...
var $c = U(function (t) {
    ...
    l = R(C({ role: Jd(F), children: n }, l), { onClick: T, onKeyDown: _ });
    let B = ie(f);
    return (
      (l = Tr(
        R(C({ store: r }, l), {
...
var ds = H(X(), 1),
  sE = (0, ds.createContext)(null),
  aE = (0, ds.createContext)(null),
  Jo = Pe([ht], [er]),
  Gc = Jo.useContext,
  uE = Jo.useScopedContext,
  cE = Jo.useProviderContext,
  lE = Jo.ContextProvider,
  fE = Jo.ScopedContextProvider;
var Zd = Ht() && rn();
function Yc(e = {}) {
  var t = e,
    { tag: o } = t,
...
var ws = class {
  ...
  op = (0, Xr.createContext)(new Map());
function Cs(e, t, o) {
  if (typeof IntersectionObserver > "u") return;
  let r = na(() => `${o.rootMargin}`),
    n = (0, Xr.useContext)(op),
    { enabled: i } = o;
  (0, Xr.useEffect)(() => {
    let s = e.current;
    if (!i || !s) return;
...
var Bl = () => (0, ir.useContext)(Ps);
function Wl({ children: e, closeOnSelect: t, startTime: o, mouseDidMove: r }) {
...
var _e = H(ve(), 1),
  ...
  Os = ({ menuHeight: e, children: t }) => {
    let o = Qo(),
      ...
      i = Math.min(n, Jc);
    return e > i
      ? (0, _e.jsx)(ip, { children: t })
      : (0, _e.jsx)("div", { className: be(o && Ss), children: t });
  },
  ip = ({ children: e }) => {
    let t = Qo(),
      o = (0, It.useRef)(null),
    ...
    (Cs(
      ...
      (0, It.useEffect)(() => {
        ...
        return (
          s === "down" ? (p = setInterval(x, jl)) : clearInterval(p),
          s === "up" ? (g = setInterval(P, jl)) : clearInterval(g),
          () => {
    ...
    return (0, _e.jsxs)("div", {
      className: Il,
      children: [
        i && !u && (0, _e.jsx)(zl, { direction: "up", onMouseEnter: l, onMouseLeave: v }),
        (0, _e.jsx)(Gs, {
          ref: o,
          onWheel: v,
          children: (0, _e.jsxs)("div", {
            className: Hl,
            children: [
              (0, _e.jsx)("div", { ref: r, className: Ll }),
              (0, _e.jsx)("div", { className: be(t && Ss), children: e }),
              (0, _e.jsx)("div", { ref: n, className: Nl }),
            ],
          }),
        }),
        i && !f && (0, _e.jsx)(zl, { direction: "down", onMouseEnter: d, onMouseLeave: v }),
      ],
    });
  },
  zl = ({ direction: e, onMouseEnter: t, onMouseLeave: o }) =>
    (0, _e.jsxs)(Zo, {
      gap: 0,
      className: e === "up" ? Rl : Al,
      children: [
        e === "down" && (0, _e.jsx)("div", { className: _l }),
        (0, _e.jsx)("div", {
          role: "presentation",
          ...
          onMouseLeave: o,
          className: Fl,
          children: (0, _e.jsx)($s, { direction: e }),
        }),
        e === "up" && (0, _e.jsx)("div", { className: Tl }),
      ],
    });
var ei = H(X(), 1);
var sp = !0;
function ks(e, t) {
  let [o, r] = (0, ei.useState)(() =>
    Dt(e) || t?.every((n) => Dt(n.enabled) || n.enabled === !1) ? sp : e === !1
  );
  return (
    (0, ei.useEffect)(() => {
      let n = !0;
      return (
        (async () => {
          let [s, a] = await Promise.all([Ul(e), $l(t)]);
          n && r(s === !1 || a);
        })(),
        () => {
          n = !1;
...
async function $l(e) {
  ...
  for (let t of e) {
    if (t.type === "separator" || (await Ul(t.enabled)) === !1) continue;
    let r = Dt(t.submenu) ? t.submenu() : t.submenu;
    if (!(r && (await $l(r)))) return !1;
  }
  return !0;
}
var N = H(ve(), 1),
        ...
        w = (0, N.jsxs)(Gn, {
          ...
          children: [
              ...
              (0, N.jsxs)(qn, {
                ...
                render: (E) =>
                  (0, N.jsx)(Jl, {
                    ...E,
                    hasSubmenu: !0,
                    className: be(E.className, f && gs, f && f.padding !== "compact" && xs),
                  }),
                children: [
                  d.checked && (0, N.jsx)(oi, { className: vs, children: (0, N.jsx)(ri, {}) }),
                  f && (0, N.jsx)(Xl, { icon: f }),
                  (0, N.jsx)("span", { className: be(Yr, ar), children: o }),
                  m && (0, N.jsx)(Ql, { acceleratorLabelTokens: m }),
                  (0, N.jsx)("span", {
                    className: ol,
                    "aria-hidden": "true",
                    children: (0, N.jsx)(zs, {}),
            ...
            (0, N.jsx)($n, {
              ...
              className: be(vl, y && bl, r?.className, qs),
              style: { width: a },
              ...
              children: (0, N.jsx)(fp, {
                ...
                menuHeight: P,
                withinCombobox: p,
                children: (0, N.jsx)(hp, { items: t, onSelect: i, submenuPlacement: u }),
              }),
            }),
          ],
        });
...
var fp = me.memo(function ({
            ...
            children: (0, N.jsxs)("div", {
              ...
              children: [
                (0, N.jsxs)("div", {
                  className: xl,
                  children: [
                    (0, N.jsx)("div", { className: wl, children: (0, N.jsx)(Us, {}) }),
                    (0, N.jsx)(Xn, {
                      ref: s,
                      autoFocus: !0,
                      autoSelect: !0,
  ...
  mp = (e) => (0, N.jsx)(Yn, { ...e, className: be(pl, e.className) }),
  ql = 14,
  Xl = ({ icon: e }) => {
    let t = { height: e.height ?? ql, width: e.width ?? ql };
    return e.inlineSVG
...
var Jl = me.memo(
    me.forwardRef(function ({ ...t }, o) {
      ...
      return (0, N.jsx)("div", {
        ref: r,
        className: be(tl, Js),
        children: (0, N.jsx)(pp, { ref: o, wrapperRef: r, ...t }),
      });
    })
  ),
  pp = me.memo(
    me.forwardRef(function (
      ...
      let { closeOnSelect: P, startTime: y, mouseDidMove: w } = Bl(),
        E = Qo(),
        S = Pt(),
        T = ks(l);
      ...
      let k = me.useRef(null),
        ...
        D = me.useCallback(
          (J) => {
            ...
            if (F && J.key === "Enter") {
              (J.preventDefault(),
                J.stopPropagation(),
                S.getState().open ? (B?.(dp(J)), S.hideAll()) : O());
              return;
            }
        ...
        A = me.useCallback(
          (J) => {
            ...
            !F || !js(J.button) || (As(w, y) && (b.suppressFor(J.currentTarget), B?.(J), I(J)));
          },
          [B, I, y, w, b, F]
        ),
        z = me.useCallback(
      ...
      (c
        ...
        : u &&
          (V.children = (0, N.jsxs)("span", {
            className: Yr,
            children: [(0, N.jsx)(Xl, { icon: u }), V.children],
          })),
        f &&
        ...
        s &&
          ...
          (V.children = (0, N.jsxs)("span", {
            className: cl,
            children: [(0, N.jsx)(oi, { className: vs, children: (0, N.jsx)(ri, {}) }), V.children],
          })),
        a
          ? (V.children = (0, N.jsxs)(N.Fragment, {
              children: [
                (0, N.jsx)("span", { className: ar, children: V.children }),
                (0, N.jsx)(Ql, { acceleratorLabelTokens: a }),
              ],
            }))
          : r
            ? (V.children = (0, N.jsxs)(N.Fragment, {
                children: [
                  ...
                  i
                    ...
                    : (0, N.jsx)("span", { className: be(al, n), children: r }),
                ],
              }))
            : m
              ? (V.children = (0, N.jsx)("span", { className: be(Yr, ar), children: V.children }))
              : (V.children = (0, N.jsx)("span", { className: be(ll, ar), children: V.children })));
      ...
      return d
        ? (0, N.jsxs)(N.Fragment, {
            children: [de, (0, N.jsx)(bp, { anchorRef: T && v ? g : k, children: d })],
          })
        : de;
    })
  );
...
var bp = me.memo(function ({ anchorRef: t, children: o }) {
...
var hp = me.memo(({ items: e, onSelect: t, submenuPlacement: o }) => {
  let r = e.some((n) => n.type !== "separator" && n.checked === !0 && !n.icon);
  return e.map((n) => {
    let i = n.path.join("+");
    if (n.type === "separator") return (0, N.jsx)(mp, {}, i);
    let s = be(r && n.checked !== !0 && !n.icon && ml),
      a = xp(n);
    if (n.submenu) {
...
var Ts = H(ve(), 1),
  yp = 10,
  Zl = { placement: "bottom-start", orientation: "vertical" };
function kI({
  menu: e,
  onClose: t,
  ...
  let [s, a] = (0, Fe.useState)(""),
    ...
    c = (0, Fe.useMemo)(
      () =>
        !e || e.config.searchable === !1 ? !1 : e.config.searchable === !0 ? !0 : rf(e.items) > yp,
      [e]
    ),
    f = (0, Fe.useDeferredValue)(s),
    m = (0, Fe.useMemo)(
      () => (!c || !e?.items ? (e?.items ?? []) : ef(f, e.items)),
      [c, e?.items, f]
    ),
    l = Pr({ ...Zl, placement: e?.config.placement ?? Zl.placement }),
  ...
  let h = (0, Fe.useCallback)(() => e?.config.location ?? null, [e?.config.location]),
    ...
    y = (0, Fe.useMemo)(
      () => ({
        ...
        className: be(hl, e?.config?.className),
        onKeyDown: n,
        onKeyUp: i,
      }),
...
function RI(e) {
  return e instanceof Element ? !!e.closest(Yl) || Ds(e) : !1;
}
function wp(e, t) {
...
function rf(e) {
  let t = 0;
  for (let o of e) tf(o) && ((t += 1), Array.isArray(o.submenu) && (t += rf(o.submenu)));
  return t;
}
export {
  Xt as a,
...
//# sourceMappingURL=chunk-WB2WRCD6.mjs.map
