  ...
  yt = e(() => {
    (u(),
      ...
      (J = {
        ...
        hj3sUMZDX: { isNullable: !0, type: f.String },
        id: { isNullable: !1, type: f.String },
        lmOHDeIEY: { isNullable: !0, type: f.RichText },
        nextItemId: { isNullable: !0, type: f.String },
        previousItemId: { isNullable: !0, type: f.String },
        updatedAt: { isNullable: !0, type: f.Date },
        vU2tk9qoD: { isNullable: !0, type: f.Enum },
        zH4tK0Xr9: { isNullable: !0, type: f.String },
      }),
      (ct = [`id`]),
      (Y = { type: 1 }),
      (lt = [`previousItemId`]),
      ...
      (Q = {
        collectionByLocaleId: {
          default: new et({
            chunks: [
              new URL(
                `./qQzBoJMop-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/HNaBMm4odkGDUaePEVgS/YTQpWbWAZQcHS4PgRUKM/qQzBoJMop.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `64fbfb20-8a06-4c35-a0f2-3f6acfc2bee1default`,
            indexes: [
              new G({
                collation: Y,
                collectionSchema: J,
                ...
                range: { from: 0, to: 625 },
                url: new URL(
                  `./qQzBoJMop-indexes-default-0.framercms`,
                  `https://framerusercontent.com/modules/HNaBMm4odkGDUaePEVgS/YTQpWbWAZQcHS4PgRUKM/qQzBoJMop.js`
                ).href.replace(`/modules/`, `/cms/`),
              }),
              new G({
        ...
        displayName: `Legal`,
        id: `64fbfb20-8a06-4c35-a0f2-3f6acfc2bee1`,
      }),
      ($ = Q),
      d(Q, {
        vU2tk9qoD: {
          defaultValue: `eKVVpthfA`,
          options: [`eKVVpthfA`, `A0xV7x9ph`, `L6pZrpY4j`],
          optionTitles: [`Privacy Policy`, `Terms & Conditions`, `Acceptable Use`],
          title: `Document Type`,
          type: f.Enum,
        },
        zH4tK0Xr9: { defaultValue: ``, title: `Title`, type: f.String },
        hj3sUMZDX: { preventLocalization: !1, title: `Slug`, type: f.String },
        lmOHDeIEY: { defaultValue: ``, title: `Content`, type: f.RichText },
        createdAt: { title: `Created`, type: f.Date },
        updatedAt: { title: `Updated`, type: f.Date },
        previousItemId: {
          dataIdentifier: `local-module:collection/qQzBoJMop:default`,
          title: `Previous`,
...
export { $ as n, yt as t };
//# sourceMappingURL=qQzBoJMop.DSc1yP4o.mjs.map
