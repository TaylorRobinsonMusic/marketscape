...
import { C as p, a as m, r as ne, t as re } from "./motion.BxtCy6Qp.mjs";
import {
  $ as h,
  At as g,
  E as _,
...
e(() => {
  (l(),
    ...
    (Y = ae(x(g(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (X = `framer-6jWyo`),
        ...
        let { style: l, className: u, layoutId: d, variant: f, ...m } = Ce(e),
          {
            ...
            setVariant: b,
            variants: x,
          } = oe({ defaultVariant: `HK2sXlagE`, ref: i, variant: f, variantClassNames: ge }),
          S = we(e, x),
          C = y(X);
        return s(ne, {
          id: d ?? a,
            ...
            children: s(Se, {
              ...
              children: s(ce, {
                ...
                children: c(Y, {
                  ...
                  __targetOpacity: 1,
                  className: `${y(C, `framer-n0ccwk`, u, h)} framer-bmpgw8`,
    ...
    ie(Q, [{ explicitInter: !0, fonts: [] }, ...K, ...q], { supportsExplicitInterCodegen: !0 }),
    ($ = {
      exports: {
...
//# sourceMappingURL=PX9hIOIVM.CIjbPugW.mjs.map
