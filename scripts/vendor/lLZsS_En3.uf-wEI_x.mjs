...
async function Ue(e) {
  let t = Math.floor(Qe * (Math.random() + 1) * 2 ** (e - 1));
  await new Promise((e) => {
    setTimeout(e, t);
  });
}
...
var C,
  ...
  rt = e(() => {
    (t(),
      ...
      (Ke = (e, t, n) => (
        (n = e == null ? {} : w(O(e))),
        Ge(!t && e && e.__esModule ? n : T(n, `default`, { value: e, enumerable: !0 }), e)
      )),
...
` +
      ...
      (Xe = class {
        ...
        ensureLength(e) {
          ...
          let n = new Uint8Array(Math.ceil(t * Ye) + e);
        ...
        constructor() {
          (M(this, `offset`, 0),
            M(this, `bytes`, new Uint8Array(Je)),
      ...
      (V = 3),
      (Qe = 250),
      ($e = [408, 429, 500, 502, 503, 504]),
      (H = async (e, t) => {
        let n = 0;
        for (;;) {
          try {
            let r = await fetch(e, t);
            if (!$e.includes(r.status) || ++n > V) return r;
          } catch (e) {
      ...
      (U = class {
        async loadModel() {
          ...
          return (m(e, `Failed to load model`), Ze.deserialize(e));
        }
        async getModel() {
          return (
      ...
      (nt = class {
        ...
        constructor(e) {
          ((this.options = e),
            ...
            M(this, `chunks`),
            (this.chunks = this.options.chunks.map((e, t) => new tt(t, e))),
...
function it(e) {
  return typeof e == `object` && !!e && !i(e) && st in e;
}
function at(e, ...t) {
  if (!e) throw Error(`Assertion Error` + (t.length > 0 ? `: ` + t.join(` `) : ``));
}
      ...
      switch (i[0]) {
        ...
        case 3: {
          ...
          for (let t of s) {
            ...
            let r = e[n];
            r && (it(r) && r.preload(), (a[t] = r));
          }
          let c = e[n];
          return (
            at(c, `Module not found`),
            it(c) && c.preload(),
            r(te, {
...
var G,
  ...
  Ht = e(() => {
    (u(),
      ...
      lt(),
      (K = {
        cI1vuPIzs: { isNullable: !0, type: f.String },
        createdAt: { isNullable: !0, type: f.Date },
        DrYfTxF7n: { isNullable: !0, type: f.VectorSetItem },
        DZ2pLeHJ7: { isNullable: !0, type: f.String },
        fFs6jUAsL: { isNullable: !0, type: f.Date },
        g9kE3q2_2: { isNullable: !0, type: f.ResponsiveImage },
        Gc3rlM5ye: { isNullable: !0, type: f.String },
        id: { isNullable: !1, type: f.String },
        IqPLs_RYT: { isNullable: !0, type: f.String },
        j1M4bUoVF: { isNullable: !0, type: f.VectorSetItem },
        lNNn_EvHN: {
          definition: { isNullable: !0, type: f.String },
          isNullable: !0,
          type: f.Array,
        },
        m8uStjAdn: { isNullable: !0, type: f.String },
        nextItemId: { isNullable: !0, type: f.String },
        nTGt_JRqg: { isNullable: !0, type: f.String },
        O_7BF1LXh: { isNullable: !0, type: f.String },
        OLWq7yo1J: { isNullable: !0, type: f.RichText },
        orAEBIKwx: { isNullable: !0, type: f.RichText },
        previousItemId: { isNullable: !0, type: f.String },
        qslGWkXvo: { isNullable: !0, type: f.String },
        tJaeAOeuE: { isNullable: !0, type: f.VectorSetItem },
        tw4idYTZb: { isNullable: !0, type: f.String },
        U0FLwL6Lu: { isNullable: !0, type: f.Boolean },
        updatedAt: { isNullable: !0, type: f.Date },
        VNdPTJ1mw: { isNullable: !0, type: f.Enum },
        wKHorg_DW: { isNullable: !0, type: f.String },
        yKuZxAi18: { isNullable: !0, type: f.String },
        Yy2HLMNJr: { isNullable: !0, type: f.String },
      }),
      (ut = [`id`]),
      (q = { type: 1 }),
      (dt = [`previousItemId`]),
      ...
      (Ft = [`tw4idYTZb`]),
      (It = [
        () => import(`./uWHdr3sGD.o37ClM1f.mjs`),
        () => import(`./UK1mJMXbD.PtltWgdZ.mjs`),
        () => import(`./BEBDTSc4n.BBK9sLkD.mjs`),
        () => import(`./qWElYzziG.CW9lYO8k.mjs`),
        () => import(`./DNDZR_hI6.DHPVWtDC.mjs`),
        () => import(`./O0JMZV7V1.uOQ6A-z8.mjs`),
      ]),
      (Lt = (e) => {
        let t = It[e];
      ...
      (Z = {
        collectionByLocaleId: {
          default: new nt({
            chunks: [
              new URL(
                `./lLZsS_En3-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/TVJiuWmTPMKRpmV5wkSY/UkbJkuS37egKc2WjDa1k/lLZsS_En3.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `d279f86c-3bac-4a8a-9d38-f2b6fd821378default`,
            indexes: [
              new U({
                collation: q,
                collectionSchema: K,
                ...
                range: { from: 0, to: 97 },
                url: new URL(
                  `./lLZsS_En3-indexes-default-0.framercms`,
                  `https://framerusercontent.com/modules/TVJiuWmTPMKRpmV5wkSY/UkbJkuS37egKc2WjDa1k/lLZsS_En3.js`
                ).href.replace(`/modules/`, `/cms/`),
              }),
              new U({
        ...
        id: `d279f86c-3bac-4a8a-9d38-f2b6fd821378`,
      }),
      (zt = Z),
      d(Z, {
        m8uStjAdn: { defaultValue: ``, title: `Title`, type: f.String },
        wKHorg_DW: {
          dataIdentifier: `local-module:collection/wxhejvlYk:default`,
          title: `Client`,
          type: f.CollectionReference,
        },
        yKuZxAi18: { preventLocalization: !1, title: `Slug`, type: f.String },
        g9kE3q2_2: { title: `Thumbnail`, type: f.ResponsiveImage },
        VNdPTJ1mw: {
          defaultValue: `FgA5TouBW`,
          options: [`FgA5TouBW`, `qh21dhY5Y`, `aP__d1iJl`, `EqdZiINq2`, `oCud9Z8PD`, `SfCbRgF1l`],
          optionTitles: [
            `Legal Tech`,
            `Logistics`,
            `FinTech`,
        ...
        fFs6jUAsL: { title: `Published`, type: f.Date },
        IqPLs_RYT: {
          defaultValue: ``,
          displayTextArea: !0,
        ...
        U0FLwL6Lu: { defaultValue: !1, title: `Featured`, type: f.Boolean },
        DZ2pLeHJ7: {
          defaultValue: ``,
          displayTextArea: !0,
          title: `Primary Metric Headline`,
          type: f.String,
        },
        orAEBIKwx: { defaultValue: ``, title: `The Operational Friction`, type: f.RichText },
        OLWq7yo1J: { defaultValue: ``, title: `The Architecture Blueprint`, type: f.RichText },
        lNNn_EvHN: {
          dataIdentifier: `local-module:collection/wxhejvlYk:default`,
          title: `Tech Stack`,
        ...
        previousItemId: {
          dataIdentifier: `local-module:collection/lLZsS_En3:default`,
          title: `Previous`,
          type: f.CollectionReference,
        },
        nextItemId: {
      ...
      (Q = (e, t) => {
        switch ((t?.fallback, e)) {
          ...
          case `oCud9Z8PD`:
            return `Logistics & Global Supply Chain`;
          case `SfCbRgF1l`:
            return `B2B SaaS`;
          default:
            return ``;
          ...
          let [n] = await X.query(
            {
              ...
              select: [{ name: `yKuZxAi18`, type: `Identifier` }],
              where: {
          ...
          let [n] = await X.query(
            {
              ...
              where: {
                left: { name: `yKuZxAi18`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
        ...
        exports: {
          default: {
            ...
            annotations: {
              ...
              framerSlug: `yKuZxAi18`,
              framerRecordIdKey: `id`,
              framerCollectionId: `lLZsS_En3`,
          ...
          VNdPTJ1mwToDisplayName: { type: `variable`, annotations: { framerContractVersion: `1` } },
...
export { zt as a, Ht as i, $ as n, Vt as o, Bt as r, Q as t };
//# sourceMappingURL=lLZsS_En3.uf-wEI_x.mjs.map
