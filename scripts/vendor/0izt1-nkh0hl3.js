(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    function h(e) {
      return g(e) && ("[object Error]" === f(e) || e instanceof Error);
    }
    function p(e) {
      return g(e) && "[object Date]" === f(e);
    }
    function f(e) {
    ...
    function b(e, t, r = 0) {
      ...
      let f = Object.keys(t),
        E =
          ...
          l);
      try {
        e.showHidden && Object.getOwnPropertyNames && (f = Object.getOwnPropertyNames(t));
      } catch (e) {}
      if (h(t) && (f.indexOf("message") >= 0 || f.indexOf("description") >= 0)) return y(t);
      if (0 === f.length)
        if (!u(e.stylize)) return t;
          ...
          if (p(t)) return e.stylize(Date.prototype.toISOString.call(t), "date");
          if (h(t)) return y(t);
        }
      let v = "",
        L = !1,
        O = ["{\n", "\n}"];
      if (
        (Array.isArray(t) && ((L = !0), (O = ["[\n", "\n]"])),
        u(t) && (v = " [Function" + (t.name ? ": " + t.name : "") + "]"),
        m(t) && (v = " " + RegExp.prototype.toString.call(t)),
        p(t) && (v = " " + Date.prototype.toUTCString.call(t)),
        h(t) && (v = " " + y(t)),
        0 === f.length && (!L || 0 == t.length))
      )
        return O[0] + v + O[1];
      if (r < 0)
        if (m(t)) return e.stylize(RegExp.prototype.toString.call(t), "regexp");
        ...
        (o = L
          ? (function (e, t, r, n, s) {
              ...
              for (let s = 0, a = t.length; s < a; ++s)
                d(t, String(s)) ? i.push(w(e, t, r, n, String(s), !0)) : i.push("");
              return (
                s.forEach((s) => {
    ...
    let v = {
                    ...
                    for (let u = 0; u < n.length - 1; u++)
                      if (37 === n.charCodeAt(u)) {
                        ...
                        if (a + 1 !== t.length) {
                          ...
                          (c !== u - 1 && (l += n.slice(c, u - 1)), (l += o), (c = u + 1));
                        } else 37 === d && ((l += n.slice(c, u)), (c = u + 1));
                      }
                    0 !== c && (a++, (u = " "), c < n.length && (l += n.slice(c)));
                  }
                  for (; a < t.length; ) {
                    let r = t[a];
        ...
        prettyFormatLogObj: function (e, t) {
          return e.reduce((e, r) => (k(r) ? e.errors.push(N(r, t)) : e.args.push(r), e), {
            args: [],
            errors: [],
          });
        },
    ...
    let A = {
        ...
        prettyLogTimeZone: j.IS_PRODUCTION ? "UTC" : "local",
        prettyErrorStackTemplate: "  • {{fileName}}	{{method}}\n	{{filePathWithLine}}",
        prettyErrorTemplate: "\n{{errorName}} {{errorMessage}}\nerror stack:\n{{errorStack}}",
        prettyLogTemplate: "{{hh}}:{{MM}}:{{ss}}:{{ms}} [{{logLevelName}}] ",
        stylePrettyLogs: !j.IS_PRODUCTION,
        prettyLogStyles: { name: "yellow", dateIsoStr: "blue" },
        type: j.IS_PRODUCTION ? "json" : "pretty",
      },
      R = new (class extends I {
        constructor(e, t) {
  ...
  (e) => {
    ...
    let c = () => "true" === new URL(document.URL).searchParams.get("prerender");
    function d({ embedStore: e }) {
      return (
    ...
    (e.i(478618),
      e.s(["useBookerEmbedEvents", () => S, "useSlotsViewOnSmallScreen", () => E], 867426));
    var w = e.i(313069);
    let S = ({ eventId: e, eventSlug: t, schedule: r }) => {
      ...
      v = ["__iframeReady", "__dimensionChanged", "__connectInitiated", "linkPrerendered"];
    {
    ...
    let L = (e) =>
      ...
      P = (e) => {
        let [, t] = (0, n.useState)({});
        return (
          (0, n.useEffect)(() => L({ elementName: e, setState: t, styles: !0 }), []),
          (p.styles || {})[e] || {}
        );
      },
      C = (e) => {
        let [, t] = (0, n.useState)({});
        return (
          (0, n.useEffect)(() => L({ elementName: e, setState: t, styles: !1 }), []),
          (p.nonStyles || {})[e] || {}
        );
      },
      T = () => {
    ...
    async function j({ newlyRecordedResponseId: e, toBeThereParams: t, toRemoveParams: r }) {
    ...
    let R = {
      ui: function (e) {
        ...
        if (n || s)
          ...
          Array.from(new Set([...(n ? Object.keys(n) : []), ...(s ? Object.keys(s) : [])]))))
            t[e] = { ...n?.[e], ...s?.[e] };
        let i = e;
        if ((e = { ...p.uiConfig, ...i, ...(t ? { cssVarsPerTheme: t } : {}) }).cssVarsPerTheme) {
          let t = (function (e) {
            if (!e) return e;
            let t = {};
            for (let [r, n] of Object.entries(e))
        ...
        (e.colorScheme && _(e.colorScheme),
          p.setUiConfig && ((p.uiConfig = a = e), p.setUiConfig.forEach((e) => e(a))));
        var a,
          o = r || {};
        for (let [, e] of ((p.styles = o), Object.entries(p.reactStylesStateSetters)))
          e((e) => ({ ...e, ...o }));
        var l = r || {};
            ...
            d({ embedStore: p })
              ? F()
                ...
                : (I(),
                  ...
                  c() ? o?.fire("linkPrerendered", {}) : o?.fire("linkReady", {}))
              : l(e);
          }));
      },
      connect: async function ({ config: e, params: t }) {
        ...
        (await A(),
          ...
          await U({ toBeThereParams: a, toRemoveParams: l }));
        let u = await m(t);
        "number" == typeof u &&
          (await j({ newlyRecordedResponseId: u, toBeThereParams: a, toRemoveParams: l }));
      },
      __reloadInitiated: function (e) {
        (g("Method: __reloadInitiated called"), (p.pageData.reloadInitiated = !0));
      },
    };
    function F() {
    ...
    function D({ bookerState: e, slotsQuery: t }) {
    ...
    !(function () {
      ...
      (g(`Slots will ${i ? "" : "NOT "}be fetched`),
        window.addEventListener("message", (e) => {
          ...
          if (!t) return;
          let r = t.method;
          "CAL" === t.originator && "string" == typeof r && R[r]?.(t.arg);
        }),
        ...
        o?.on("*", (e) => {
          if (c() && !v.includes(e.detail.type)) return;
          let t = e.detail;
        ...
        "true" !== e.searchParams.get("preload") && t?.isEmbed()
          ? (function () {
              if (
                (o?.fire("__iframeReady", { isPrerendering: c() }),
                (p.renderState = "inProgress"),
                p.state !== h.NOT_INITIALIZED)
              )
                return g("Embed Iframe already initialized");
              ((p.state = h.INITIALIZED), g("Initializing embed-iframe"));
              let e = window.CalComPageStatus;
              F()
                ? M(e)
                : (function ({ embedStore: e }) {
                    ...
                    l(function i() {
                      ...
                      let d = getComputedStyle(a),
                        m = Math.ceil(
                          parseFloat(d.height) +
                            parseFloat(d.marginTop) +
                            parseFloat(d.marginBottom)
                        ),
                        g = Math.ceil(
                          parseFloat(d.width) + parseFloat(d.marginLeft) + parseFloat(d.marginRight)
                        ),
                        h = n ? u : m,
                        p = n ? c : g;
                      (h &&
                        p &&
                        ((t === h && r === p && e.providedCorrectHeightToParent) ||
                          ((t = h),
                          (r = p),
