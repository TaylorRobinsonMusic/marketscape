...
var g = b("modules-runtime");
async function J(e, t, o, r, l, y) {
  let { file: u, debugName: a } = A(t, l),
    s = P(o);
  if (s) {
    g.error("Error in", a, ":", s);
    let d = F(t),
  ...
  if (!w(o.__FramerMetadata__)) {
    g.warn(a, "is missing export '__FramerMetadata__'");
    return;
  }
...
export { J as a, A as b, P as c, X as d, Y as e, Z as f, ee as g, te as h };
//# sourceMappingURL=chunk-O2O6YN2X.mjs.map
