(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    class t extends Error {
      ...
      data;
      constructor(e, r, t) {
        (super(r), (this.code = e), (this.data = t));
      }
      static get Factory() {
        return new Proxy(t, {
          get(e, o) {
            if (o in r.ErrorCode) {
              let e = r.ErrorCode[o];
              return (r, o) => new t(e, r, o);
            }
            throw Error(`Unknown error code: ${o}`);
          },
        });
      }
    }
    (Object.values(r.ErrorCode),
      e.s([
        "ErrorWithCode",
        0,
        t,
        ...
        function (e) {
          return e instanceof Error
            ...
            : "string" == typeof e
              ? Error(e, { cause: e })
              : Error(`Unhandled error of type '${typeof e}''`);
        },
      ]));
  },
  605681,
    ...
    class r extends Error {
      ...
      constructor(e) {
        (super(e.message ?? `HTTP Error ${e.statusCode} `),
          ...
          (this.name = r.prototype.constructor.name),
          (this.cause = e.cause),
  ...
  (e) => {
      ...
      i = (e) => {
        let { error: t } = e,
          s = [
            ...
            ["http.url", t instanceof o.HttpError ? t.url : void 0],
            ["http.status", t instanceof o.HttpError ? t.statusCode : void 0],
            ["http.cause", t instanceof o.HttpError ? t.cause?.message : void 0],
    ...
    e.s([
      ...
      0,
      (e) => {
        let { message: o, statusCode: n, error: d, displayDebug: l } = { ...a, ...e };
        return (
          (0, t.useLayoutEffect)(() => {
            n && (window.CalComPageStatus = n.toString());
          }, [n]),
          (0, r.jsxs)(r.Fragment, {
            children: [
              (0, r.jsx)("div", {
  ...
  (e) => {
    ...
    var r = e.i(843476),
      ...
      i = e.i(684219),
      n = e.i(821410);
    let d = i.default.getSubLogger({ prefix: ["[redactError]"] });
    var l = e.i(323758);
    let u = i.default.getSubLogger({ prefix: ["[error]"] });
    e.s(
      [
        "default",
        0,
        function ({ error: e, reset: i }) {
          o.default.useEffect(() => {
            (u.error(e), (0, t.captureException)(e));
          }, [e]);
          let c = o.default.useMemo(() => {
            let r = (0, s.getErrorFromUnknown)(e);
            if (r instanceof a.HttpError) {
              var t;
              let e,
                o =
                  (t = r) instanceof Error
                    ? (d.debug("Type of Error: ", t.constructor),
                      ((e = t.name || ""), /Prisma/i.test(e) && n.IS_PRODUCTION)
                        ? (d.error("Error: ", JSON.stringify(t)),
  ...
  (e) => {
    ...
    let a = (e) => (
      ...
      (0, r.jsx)("html", {
        children: (0, r.jsx)("body", { children: (0, r.jsx)(s.default, { ...e }) }),
      })
    );
    e.s(["GlobalError", 0, a, "default", 0, a]);
  },
]);
