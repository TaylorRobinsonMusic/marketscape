      ...
      eu =
        ((n = () => {
          let e = j("color"),
            ...
            G = () => [X, F, i],
            C = () => [W, "full", "auto", ...G()],
            O = () => [S, "none", "subgrid", X, F],
            N = () => ["auto", { span: ["full", S, X, F] }, S, X, F],
            I = () => [S, "auto", X, F],
            T = () => ["auto", "min", "max", "fr", X, F],
            $ = () => [
              "start",
              "end",
              "center",
          ...
          return {
            ...
            classGroups: {
              aspect: [{ aspect: ["auto", "square", W, F, X, g] }],
              container: ["container"],
              columns: [{ columns: [P, F, X, s] }],
              ...
              "max-w": [{ "max-w": [s, "screen", "none", "prose", { screen: [n] }, ...R()] }],
              h: [{ h: ["screen", "lh", ...R()] }],
              ...
              "text-decoration-thickness": [{ decoration: [P, "from-font", "auto", X, H] }],
              ...
              "bg-image": [
                {
                  bg: [
                    "none",
                    {
                      linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, S, X, F],
                      radial: ["", X, F],
                      conic: [S, X, F],
                    },
                    eo,
        ...
        (l = (e) => {
          ...
          return (
            (o = (r = {
              ...
              sortModifiers:
                ((i = new Map()),
                s.orderSensitiveModifiers.forEach((e, r) => {
                  i.set(e, 1e6 + r);
                }),
                (e) => {
                  let r = [],
                  ...
                  for (let t = 0; t < e.length; t++) {
                    let l = e[t],
                      ...
                      n = i.has(l);
                    a || n
                      ? (o.length > 0 && (o.sort(), r.push(...o), (o = [])), r.push(l))
                      : o.push(l);
                  }
