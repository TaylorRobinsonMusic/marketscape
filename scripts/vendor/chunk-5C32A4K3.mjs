...
function W(e, t) {
  switch (e.type) {
    ...
    case "table":
      t.table?.(e);
      for (let r of e.children) xt(r, t);
      return;
  }
}
function Ge(e, t) {
...
function H(e, t, r) {
  return (
    ...
    ye(e) || D(e) ? r(e) : { type: "LiteralValue", value: ue(t, void 0) }
  );
}
function Pt(e, t, r, n) {
  function i(o) {
    return D(o) ? n(o) : { type: "LiteralValue", value: o };
  }
        ...
        o.has(l.from) ||
          (r.options.includes(l.from) &&
            ...
            a.push({
              ...
              then: H(l.to, e.outputType, i),
            })));
      return { type: "Case", value: t, conditions: a, else: H(e.default, e.outputType, i) };
    }
...
function Mt(e, t, r, n, i, o) {
  ...
  for (let { itemKey: d, transforms: R } of a) {
    ...
    let f = [],
      ...
      m = j(d, u, r, n, o, x);
    for (let s of R) X(s.name) && (m = Pt(s, m, u, y));
    l.push({ expression: m, optionalVariables: f });
  }
  let c = e.collectionFiltersOperator ?? je;
  switch (c) {
    case "all":
      return wt(l, i);
    case "any":
...
function wt(e, t) {
  if (e.length !== 0)
    return e.reduce(
      (r, n) => {
        let i = Ot(n.expression, n.optionalVariables, t);
...
function At(e, t) {
  ...
  let r = e.reduce(
    (o, a) => {
      let l = vt(a.expression, a.optionalVariables, t);
  ...
  if (e.collectionFilters && e.collectionFilters.filters.length === 1) {
    ...
    if ((b(a, "filter should exist"), a.itemKey)) {
      let l = t.get(a.itemKey),
        c = j(a.itemKey, l, r, n, o),
        p = qt(e, a.transforms, c, l, i);
      if (p) return [p];
    }
  }
...
function qt(e, t, r, n, i) {
  ...
  let o = t[0];
  if ((b(o, "Transform must exist"), o.name === "isIncludedIn" && D(o.value)))
    return {
      type: "FunctionCall",
...
function Wt(e, t, r, n, i) {
  ...
  for (let l of r) {
    ...
    for (let p = 1; p < c.length; p++) {
      let d = c.slice(0, p).join("."),
        R = t.get(d);
      if (R?.type !== "collectionreference") continue;
      let L = R.dataIdentifier;
      a.set(d, L);
    }
  }
  for (let [l, c] of a) {
    ...
    o = {
      ...
      constraint: {
        type: "BinaryOperation",
        operator: "==",
        left: { type: "Identifier", name: d, collection: p },
...
function hn(e, t, r, n, i) {
  let o = {},
    a = new Set(),
    l = Lt(e);
  e.collectionFilters && (o.where = Mt(e, t, a, l, n, i));
  let c = t.get(e.getPrimaryId());
  b(c, "Control map of repeater must exist");
  let p = $t(e, c, a, l, n, i);
  (p.length > 0 && (o.orderBy = p),
    N(e.collectionStartOffset) &&
      (o.offset = { type: "LiteralValue", value: e.collectionStartOffset }),
    N(e.collectionLimit) && (o.limit = { type: "LiteralValue", value: e.collectionLimit }));
  let d = zt(c, r, a, l, i);
  return { from: Wt(e.dataIdentifier, c, a, l, i), select: d, ...o };
}
function j(e, t, r, n, i, o = !0) {
...
function Ht(e) {
  return !Q(e) || e.type !== "object"
    ...
    : e.value === null
      ? !0
      : Object.values(e.value).every(_t);
}
function kn(e) {
...
function jt(e, t) {
  let r = g(e);
  return t.nodes.document.create(void 0, Ut(e.variant, r.children, t));
}
function Ut(e, t, r) {
  return t.flatMap((n) => {
    try {
  ...
  switch (t.type) {
    ...
    case "bulletedList": {
      let n = t.children.flatMap((i) => {
        let o = i.children.flatMap((a) => S(e, a, r));
      ...
      return r.nodes.bulletedList.create(
        { ...Ne(), textDirection: t.textDirection === "inherit" ? "auto" : t.textDirection },
        n
      );
    }
    case "numberedList": {
    ...
    case "blockquote": {
      ...
      let n = t.children.flatMap((i) => S(e, i, r));
      if (n.length === 0)
        ...
        t.children.map((n) =>
          r.nodes.table_row.create(
            ...
            n.children.map((i) => {
              ...
              let a = i.children.flatMap((l) => S(e, l, r));
...
function Qt(e, t, r) {
  let n = [],
    i = {};
  for (let o of t)
    if (o.type !== "text" || o.text.length > 0) n.push(Jt(o, r));
    else {
...
function Jt(e, t) {
  return e.type === "lineBreak" ? t.nodes.lineBreak.create() : t.text(e.text, Xt(e, t));
}
function Xt(e, t) {
  let r = [];
  if (
...
var Yt = "data-framer-link",
  Zt = "data-framer-open-in-new-tab",
  er = "data-framer-smooth-scroll",
  tr = "data-framer-click-tracking-id",
  rr = "data-framer-rel",
  nr = "data-framer-preserve-params",
  ir = "framer-module",
  or = "data-module-identifier",
  ar = "data-module-props",
  lr = "data-module-width",
  cr = "data-module-alignment",
  sr = /\s+/u;
function ot(e, t) {
  let r = Ie(e),
    n = { type: "richText", variant: t, children: G(r) };
  return g(n);
}
function ur(e) {
  let t = [];
...
function dr(e) {
  ...
  switch (e.tagName) {
    ...
    case "img":
      return Ze(t, "image");
    case "video":
      return pe(t, "framer-image") || t.get("src") ? Ze(t, "video") : void 0;
    case ir:
    case "template":
      return Tr(t);
    case "table":
    ...
    case "figure": {
      ...
      let n = I(e).find((i) => i.tagName === "table");
      return n ? et(n) : void 0;
    }
  }
}
function pr(e, t, r) {
...
function fr(e, t, r) {
  return { id: h(), type: "bulletedList", textDirection: fe(t, r), children: at(e) };
}
function mr(e, t, r) {
  let n = Ir(t.get("start")) ?? 1,
    i = Vr(e, r);
  return {
    id: h(),
    type: "numberedList",
...
function at(e) {
  return I(e)
    ...
    .map((t) => ({ id: h(), type: "listItem", children: G(t) }));
}
function hr(e) {
  return { id: h(), type: "blockquote", children: G(e) };
}
function Ze(e, t) {
  let r = { id: h(), type: "media", src: e.get("src") ?? "", mediaType: t };
  if (t === "image") {
    let i = e.get("alt");
    i !== void 0 && (r.alt = i);
    let o = it(e.get("data-framer-width"));
    o !== void 0 && (r.pixelWidth = o);
    let a = it(e.get("data-framer-height"));
...
function Tr(e) {
  ...
  if (!t) return;
  let r = ut(e.get(ar)),
    n = { id: h(), type: "module", identifier: t, props: r ?? {} },
    i = e.get(lr);
...
function et(e) {
  let t = [];
  for (let r of xr(e)) t.push(yr(r));
  return { id: h(), type: "table", children: t };
}
function xr(e) {
  let t = [];
  for (let r of I(e)) {
    ...
    if (!(r.tagName !== "tbody" && r.tagName !== "thead" && r.tagName !== "tfoot"))
      for (let n of I(r)) n.tagName === "tr" && t.push(n);
  }
  return t;
}
function yr(e) {
  let t = [];
  for (let r of I(e)) (r.tagName !== "td" && r.tagName !== "th") || t.push(Rr(r));
  return { id: h(), type: "tableRow", children: t };
}
function Rr(e) {
  return {
    id: h(),
...
function br(e, t, r) {
  e.length > 0 && r.push(Cr(e, t));
}
function Cr(e, t) {
  return { id: h(), type: "text", text: e, ...t };
}
function Br() {
  return { id: h(), type: "lineBreak" };
}
function ct(e) {
  let t = e.get(Yt),
    r;
  ...
  if (r === void 0) return;
  let n = tt(e.get(rr)) ?? tt(e.get("rel")) ?? [],
    i = { link: r, openInNewTab: nt(e.get(Zt)), smoothScroll: nt(e.get(er)), relValues: n },
    o = e.get(tr);
...
function Vr(e, t) {
  ...
  if (n) return n;
  let i = I(e).find((o) => o.tagName === "li");
  return (i && st(K(i).get("style")).get("list-style-type")) || "decimal";
}
function rt(e) {
  switch (e) {
    case "auto":
...
function he(e) {
  return { type: "richText", variant: e, children: [] };
}
function yi(e, t) {
  if (B(e))
    try {
...
function gi(e) {
  return typeof e == "string" ? re(e).length === 0 : B(e) ? !Lr(g(e)) : !0;
}
function Lr(e) {
  return (
    Je(e, {
...
function dt(e, t, r) {
  ...
  ((t.cache.parentDirected = e.layout),
    Ve(e) &&
      ...
      (t.cache.parentDirectedColumnCount = N(e.gridColumnCount) ? e.gridColumnCount : void 0)),
    ...
    De(e) && ((t.cache.parentWidthType = e.widthType), (t.cache.parentHeightType = e.heightType)));
}
function Di(e, t) {
  dt(e, t, !1);
}
...
function Er(e, t) {
  if (ne(e)) {
    if (Mr(e.value)) return { ...e, type: "rich-text", value: e.value };
...
function Mr(e) {
  return B(e) && we(e.variant);
}
var Te = "[a-z1-9]+(?:-[a-z1-9]+)*",
  wr = `${Te}="[^"]*"`,
  Ar = String.raw`(?:\s+${wr})*`,
  Or = String.raw`<${Te}${Ar}\s*>`,
  vr = `(?:${Or})+`,
  Fr = String.raw`<\/\s*${Te}\s*>`,
  $r = `(?:${Fr})+`,
  qr = "[^<>]*",
  pt = String.raw`\s*`,
  Wr = new RegExp(`^${pt}${vr}${qr}${$r}${pt}$`, "iu");
function Fi(e) {
...
function ht(e, t) {
  ...
  n.doc.descendants((u) => {
    ...
    if (te(u)) {
      ...
      (c.push(m), f && a.push(x), y && l.push(x));
    }
  });
  let p = se(zr(t, r), r),
    d = p.tr,
    R = new Map();
  p.doc.descendants((u, f, y) => {
    if (w(u)) {
      let x = i[u.attrs.tag] ?? [],
        m = x.length > 1 ? x.shift() : x[0];
      m && (R.set(u, m.inlineStyles), d.setNodeMarkup(f, u.type, { ...u.attrs, ...m }));
    }
    if (te(u)) {
      let x = !1,
        m = !1,
      ...
      for (let P of u.marks)
        if (((x ||= A(P)), (m ||= v(P)), O(P))) {
          let Tt = o.length > 1 ? o.shift() : o[0];
          d.addMark(f, f + u.nodeSize, r.marks.link.create({ ...P.attrs, linkStylePreset: Tt }));
        }
      (x && (s = a.length > 1 ? a.shift() : a[0]),
        m && (s = l.length > 1 ? l.shift() : l[0]),
        s && d.addMark(f, f + u.nodeSize, r.marks.inlineStyles.create({ inlineStyles: s })));
      let xe = c.length > 1 ? c.shift() : c[0];
      xe && d.addMark(f, f + u.nodeSize, r.marks.backgroundMask.create(xe));
    }
  });
  let L = p.apply(d);
  return $(L.doc, r);
...
//# sourceMappingURL=chunk-5C32A4K3.mjs.map
