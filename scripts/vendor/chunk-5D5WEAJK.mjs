...
function O(s, r) {
  ...
  return new Promise((l, D) => {
    ...
    let C = _,
      E = 0;
    function S() {
      (document.removeEventListener("visibilitychange", x), window.clearTimeout(E), y.abort());
    }
    ...
    async function k() {
      ...
      try {
        let m = await H(s, Object.assign(Object.assign({}, h), { headers: p, signal: y.signal }));
        (await N(m),
          await V(
            m.body,
            B(
...
async function q(s, r) {
  ...
  return s.status === 401 &&
    ...
    ? (M.reportError(
      ...
      { status: "retry" })
    : { status: "error", error: new L({ data: i, message: t, status: s.status, ref: n, code: e }) };
}
var b = class {
  constructor(r) {
    g(this, "baseURL", r);
  ...
  doWithListeners(r) {
    ...
    try {
      ...
      throw (F("application_error", { message: e, area: "fetch" }), t);
    }
  }
  fetch(r, t, e = 0) {
...
var ye = new b(j().api);
export { K as a, ye as b };
//# sourceMappingURL=chunk-5D5WEAJK.mjs.map
