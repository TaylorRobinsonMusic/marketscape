(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, r, t) => {
    ...
    function a(e, r, t) {
      ...
      let i = { tree: e, cacheNode: r, stateKey: t, next: null },
        s = 1,
        l = a,
        c = i;
      for (; null !== l && s < 1; ) {
  ...
  (e, r, t) => {
    ...
    function w({ children: e, cacheNode: r }) {
      ...
      return (0, s.jsx)(O, { focusAndScrollRef: t.focusAndScrollRef, cacheNode: r, children: e });
    }
    function S({
      tree: e,
      segmentPath: r,
    ...
    r.exports = ((e, r, t) => {
      if ((r && "object" == typeof r) || "function" == typeof r)
        for (let s of o(r))
          i.call(e, s) ||
            void 0 === s ||
            n(e, s, { get: () => r[s], enumerable: !(t = a(r, s)) || t.enumerable });
      return e;
    ...
    var p = ["strict", "lax", "none"],
      ...
      h = class {
        constructor(e) {
          ...
          if (r) for (const [e, t] of d(r)) this._parsed.set(e, { name: e, value: t });
        }
        [Symbol.iterator]() {
                ...
                for (; s < e.length; ) {
                  for (r = s, o = !1; l(); )
                    if ("," === (t = e.charAt(s))) {
                      for (
                        n = s, s += 1, l(), a = s;
                        s < e.length && "=" !== (t = e.charAt(s)) && ";" !== t && "," !== t;
                      )
                        s += 1;
                      s < e.length && "=" === e.charAt(s)
                        ? ((o = !0), (s = a), i.push(e.substring(r, n)), (r = s))
                        : (s = n + 1);
                    } else s += 1;
  ...
  (e, r, t) => {
    ...
    function y(e, r) {
      ...
      if (e) for (let r of e) (t.add(r.name), null !== r.value && n.set(r.name, r.value));
    ...
    function b(e, r) {
      return Object.defineProperty(
        new d.InstantValidationError(
          `Route "${e}" accessed cookie "${r}" which is not defined in the \`samples\` of \`unstable_instant\`. Add it to the sample's \`cookies\` array, or \`{ name: "${r}", value: null }\` if it should be absent.`
        ),
        "__NEXT_ERROR_CODE",
                ...
                a.has(n) ||
                  g(
                    Object.defineProperty(
                      new d.InstantValidationError(
                        `Route "${t}" accessed header "${n}" which is not defined in the \`samples\` of \`unstable_instant\`. Add it to the sample's \`headers\` array, or \`["${n}", null]\` if it should be absent.`
                      ),
                      "__NEXT_ERROR_CODE",
        ...
        get: (n, a, o) => (
          "string" == typeof a &&
            ...
            g(
              Object.defineProperty(
                new d.InstantValidationError(
                  `Route "${t}" accessed param "${a}" which is not defined in the \`samples\` of \`unstable_instant\`. Add it to the sample's \`params\` object.`
                ),
                "__NEXT_ERROR_CODE",
    ...
    function E(e, r, t) {
      return new Proxy(e, {
        get: (e, n, a) => (
          "string" != typeof n || p.wellKnownProperties.has(n) || r.has(n) || g(O(t, n)),
          Reflect.get(e, n, a)
        ),
        has: (e, n) => (
          "string" != typeof n || p.wellKnownProperties.has(n) || r.has(n) || g(O(t, n)),
    ...
    function O(e, r) {
      return Object.defineProperty(
        new d.InstantValidationError(
          `Route "${e}" accessed searchParam "${r}" which is not defined in the \`samples\` of \`unstable_instant\`. Add it to the sample's \`searchParams\` object, or \`{ "${r}": null }\` if it should be absent.`
        ),
        "__NEXT_ERROR_CODE",
        ...
        let e = (function (e) {
          ...
          if (e) {
            for (let [t, n] of Object.entries(e))
              if (null != n)
                if (Array.isArray(n)) for (let e of n) r.append(t, e);
                else r.set(t, n);
          }
          return r;
        })(t).toString();
    ...
    function S(e, r, t) {
      if (r && t in r);
        ...
        g(
          Object.defineProperty(
            new d.InstantValidationError(
              `Route "${r}" accessed root param "${t}" which is not defined in the \`samples\` of \`unstable_instant\`. Add it to the sample's \`params\` object.`
            ),
            "__NEXT_ERROR_CODE",
                          ...
                          Object.defineProperty(o, e, {
                            get() {
                              ...
                              "prerender-ppr" === n.type
                                ? (0, l.postponeWithTracking)(t.route, r, n.dynamicTracking)
                                : (0, l.throwToInterruptStaticGeneration)(r, t, n);
                            },
                            enumerable: !0,
                          }));
                    }),
  ...
  (e, r, t) => {
    ...
    function l({ Component: r, serverProvidedParams: t }) {
      ...
      if ("u" < typeof window) {
        ...
        return ((a = i(u)), (0, n.jsx)(r, { params: a, searchParams: t }));
      }
      {
        let { createRenderSearchParamsFromClient: t } = e.r(266996),
          ...
          i = o(u);
        return (0, n.jsx)(r, { params: i, searchParams: a });
      }
    }
    ("function" == typeof t.default || ("object" == typeof t.default && null !== t.default)) &&
      void 0 === t.default.__esModule &&
