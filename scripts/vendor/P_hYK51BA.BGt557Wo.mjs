...
function r(e, n) {
  return {
    breakpoints: [
      { hash: `1ymsh4y`, mediaQuery: `(min-width: 1200px)` },
      { hash: `18jhm8t`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `5pahvf`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    robots: `max-image-preview:large`,
    serializationId: `framer-whSae`,
    title: t(e, n).title || `Terms And Conditions`,
...
//# sourceMappingURL=P_hYK51BA.BGt557Wo.mjs.map
