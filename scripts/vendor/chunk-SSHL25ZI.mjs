...
async function Se(t) {
  switch (t) {
    case "google":
      return (await import("https://app.framerstatic.com/google-ARYE6FQA.mjs")).default;
    case "fontshare":
      return (await import("https://app.framerstatic.com/fontshare-BJPAZUNQ.mjs")).default;
    default:
...
async function z(t) {
  switch (t) {
    case "google":
      return (await import("https://app.framerstatic.com/google-XHGEERJI.mjs")).default;
    case "fontshare":
      return (await import("https://app.framerstatic.com/fontshare-YWHM4ESP.mjs")).default;
    case "framer":
      return (await import("https://app.framerstatic.com/framer-font-4A6QQVCV.mjs")).default;
    default:
      throw new Error(`Unknown font source: ${t}`);
  }
}
  ...
  try {
    if (t === "framer") return Rt(Me) ? Me : void 0;
    {
      let e = (async () => {
        switch (t) {
          case "google":
            return (await import("https://app.framerstatic.com/google-WQFKJWPL.mjs")).default;
          case "fontshare":
            return (await import("https://app.framerstatic.com/fontshare-6C7YYQFW.mjs")).default;
          default:
            de(t);
        }
      })();
...
//# sourceMappingURL=chunk-SSHL25ZI.mjs.map
